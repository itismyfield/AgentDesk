...
> 성립해야 한다.
>
> Last refreshed: 2026-09-04 (against exact main 310f08096439470f7674371c206c7669385ceb78; S4, S6a, and S6b landed inventory resynced; T5 rollout and live acceptance remain pending).
...
| rollout 설정 호환 | 범위 초과 폭을 전원 허용으로 올리는 동작과 mixed-version 전체 설정 재작성 때 다이얼 키가 사라지는 문제는 S4, S6a, S6b 어디에서도 해결되지 않았다. 둘 다 rollout 전제 조건으로 남는다. |
