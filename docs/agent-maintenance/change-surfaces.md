...
- do_not_edit_without_migration_plan (giant-file):
  ...
  - `src/services/discord/{commands/text_commands.rs,
    ...
    lines).
  - `src/services/discord/placeholder_sweeper.rs` (1018 lines; +7 net from #4573 slice A — abandon-guard inflight delete decision extracted to `placeholder_sweeper/abandon_guard.rs`; #4278 kept the
