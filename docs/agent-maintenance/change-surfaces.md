...
- do_not_edit_without_migration_plan (giant-file):
  ...
  - `src/services/discord/tmux.rs` (1628 lines; test-only #4253 wires the
...
- `src/services/codex_tui/input.rs` (1710) — Codex TUI input readiness
...
- `src/services/claude_tui/input.rs` (2220) — Claude TUI input readiness
...
- `src/services/discord/session_relay_sink.rs` (1683 prod lines; +1 from #4046
