...
- do_not_edit_without_migration_plan (giant-file):
  - `src/services/discord/watchers/lifecycle.rs` (2069 lines — canonical
...
- `src/services/memory/memento.rs` (1897; +4 from #4317 carrying the resolved memory-scope channel name into capture workspace selection).
