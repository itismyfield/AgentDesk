...
- canonical_modules: `src/server/routes/*.rs` (per-domain route module).
  ...
  `src/services/auto_queue/activate_command.rs` (1412 lines, post-#1444
...
- `src/services/auto_queue.rs` (1546) and
  `src/services/auto_queue/activate_command.rs` (1412); auto-queue route
...
- `src/services/onboarding/mod.rs` (2936),
  ...
  `src/services/settings.rs` (1014) — service-layer route support surfaces
...
- `src/services/settings.rs` (1014) — settings domain service extracted from
