...
> Last refreshed: 2026-07-18 (manual: #4519 existing outbound delivery functions
> receive item-scoped structural-complexity lint baselines only; signatures,
> delivery verbs, and the callsite coverage map are unchanged.)
