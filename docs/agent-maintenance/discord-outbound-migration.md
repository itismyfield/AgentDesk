> Last refreshed: 2026-07-31 (#5022 relay-health evidence authority; outbound callsite coverage unchanged.)
...
>
> Last refreshed: 2026-07-31 (#5022 — process-local `RelayDeliveryEvidence` observes exact terminal lease attempts and outcomes for relay-health classification. The evidence store is a read-only health authority and does not add an outbound delivery verb, transport, retry, or direct-send producer; existing outbound callsite coverage remains unchanged.)
