...
| `HOSTNAME` | `src/server/mod.rs:2936` (+4 more) | Opens this turn's buffer and evicts whatever predecessor was left on this channel by a bridge exit that never reached post-loop finalize. |
