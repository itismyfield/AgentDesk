...
| `ADK_GITHUB_SYNC_ALERT_CHANNEL` | `src/github/sync.rs:1457` |  |
...
| `AGENTDESK_GH_PATH` | `src/github/mod.rs:18` (+1 more) |  |
...
| Variable | Defined at | Description |
|---|---|---|
| `ANTHROPIC_API_KEY` | `src/server/rate_limit_sync.rs:186` (+1 more) | Priority: 1) OAuth token (Claude Code subscription), 2) ANTHROPIC_API_KEY. |
...
| `GEMINI_CLIENT_ID` | `src/server/mod.rs:1504` | env vars GEMINI_CLIENT_ID / GEMINI_CLIENT_SECRET 2. |
| `GEMINI_CLIENT_SECRET` | `src/server/mod.rs:1505` | env vars GEMINI_CLIENT_ID / GEMINI_CLIENT_SECRET 2. |
...
| `OPENAI_API_KEY` | `src/server/rate_limit_sync.rs:92` | --- Codex rate limits --- Priority: 1) ~/.codex/auth.json (Codex CLI subscription), 2) OPENAI_API_KEY |
...
| `QWEN_CODE_SYSTEM_DEFAULTS_PATH` | `src/cli/doctor/orchestrator.rs:516` (+1 more) |  |
| `QWEN_CODE_SYSTEM_SETTINGS_PATH` | `src/cli/doctor/orchestrator.rs:522` (+1 more) |  |
| `QWEN_HOME` | `src/cli/doctor/orchestrator.rs:494` (+2 more) |  |
...
| `USERPROFILE` | `src/cli/doctor/orchestrator.rs:504` (+6 more) |  |
