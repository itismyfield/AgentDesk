...
| `POST` | `/api/auto-queue/cancel` | `auto_queue::cancel` | `src/server/routes/auto_queue.rs:5553` | `src/server/routes/domains/ops.rs:141` |
| `POST` | `/api/auto-queue/dispatch` | `auto_queue::dispatch` | `src/server/routes/auto_queue.rs:4229` | `src/server/routes/domains/ops.rs:111` |
| `PATCH` | `/api/auto-queue/entries/{id}` | `auto_queue::update_entry` | `src/server/routes/auto_queue.rs:4569` | `src/server/routes/domains/ops.rs:115` |
| `PATCH` | `/api/auto-queue/entries/{id}/skip` | `auto_queue::skip_entry` | `src/server/routes/auto_queue.rs:5171` | `src/server/routes/domains/ops.rs:124` |
...
| `GET` | `/api/auto-queue/history` | `auto_queue::history` | `src/server/routes/auto_queue.rs:4469` | `src/server/routes/domains/ops.rs:114` |
| `POST` | `/api/auto-queue/pause` | `auto_queue::pause` | `src/server/routes/auto_queue.rs:5442` | `src/server/routes/domains/ops.rs:139` |
| `PATCH` | `/api/auto-queue/reorder` | `auto_queue::reorder` | `src/server/routes/auto_queue.rs:5617` | `src/server/routes/domains/ops.rs:129` |
| `POST` | `/api/auto-queue/reset` | `auto_queue::reset` | `src/server/routes/auto_queue.rs:5315` | `src/server/routes/domains/ops.rs:138` |
| `POST` | `/api/auto-queue/resume` | `auto_queue::resume_run` | `src/server/routes/auto_queue.rs:5480` | `src/server/routes/domains/ops.rs:140` |
| `PATCH` | `/api/auto-queue/runs/{id}` | `auto_queue::update_run` | `src/server/routes/auto_queue.rs:5222` | `src/server/routes/domains/ops.rs:128` |
| `POST` | `/api/auto-queue/runs/{id}/entries` | `auto_queue::add_run_entry` | `src/server/routes/auto_queue.rs:4731` | `src/server/routes/domains/ops.rs:120` |
| `POST` | `/api/auto-queue/runs/{id}/order` | `auto_queue::submit_order` | `src/server/routes/auto_queue.rs:5728` | `src/server/routes/domains/ops.rs:142` |
| `POST` | `/api/auto-queue/runs/{id}/restore` | `auto_queue::restore_run` | `src/server/routes/auto_queue.rs:4903` | `src/server/routes/domains/ops.rs:116` |
| `POST` | `/api/auto-queue/slots/{agent_id}/{slot_index}/rebind` | `auto_queue::rebind_slot` | `src/server/routes/auto_queue.rs:5032` | `src/server/routes/domains/ops.rs:130` |
| `POST` | `/api/auto-queue/slots/{agent_id}/{slot_index}/reset-thread` | `auto_queue::reset_slot_thread` | `src/server/routes/auto_queue.rs:5283` | `src/server/routes/domains/ops.rs:134` |
| `GET` | `/api/auto-queue/status` | `auto_queue::status` | `src/server/routes/auto_queue.rs:4452` | `src/server/routes/domains/ops.rs:113` |
