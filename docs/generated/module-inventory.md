...
| `config` | `src/config.rs` | 3093 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 1861 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6198 | giant-file |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1040 | giant-file |
...
| `services::cluster` | `src/services/cluster/mod.rs` | 16 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5275 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 5997 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 5407 | giant-file |
...
| `services::routines::loader` | `src/services/routines/loader.rs` | 2096 | giant-file |
