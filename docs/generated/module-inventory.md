...
| `services::message_outbox_circuit_authority` | `src/services/message_outbox_circuit_authority.rs` | 478 | 478 | 0 |  |
...
| `services::provider` | `src/services/provider.rs` | 2616 | 1880 | 736 | giant-file |
