...
| `server::routes::cluster` | `src/server/routes/cluster.rs` | 304 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 4296 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 245 |  |
