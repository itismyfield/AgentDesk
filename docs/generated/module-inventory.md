...
| `services::claude` | `src/services/claude.rs` | 3595 | giant-file |
...
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 348 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 384 |  |
| `services::claude_tui::session` | `src/services/claude_tui/session.rs` | 202 |  |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 750 |  |
