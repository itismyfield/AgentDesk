...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 4022 | 2220 | 1802 | giant-file |
...
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 2874 | 1710 | 1164 | giant-file |
...
| `services::discord::health::liveness_authority` | `src/services/discord/health/liveness_authority.rs` | 920 | 548 | 372 |  |
...
| `services::discord::health::relay_auto_heal` | `src/services/discord/health/relay_auto_heal.rs` | 1969 | 721 | 1248 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5859 | 616 | 5243 |  |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1367 | 1002 | 365 | giant-file |
| `services::discord::inflight::orphan_relay_reclaim` | `src/services/discord/inflight/orphan_relay_reclaim.rs` | 821 | 307 | 514 |  |
| `services::discord::inflight::ownership_ops` | `src/services/discord/inflight/ownership_ops.rs` | 353 | 353 | 0 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3225 | 2802 | 423 | giant-file |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4789 | 1683 | 3106 | giant-file |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1666 | 918 | 748 |  |
...
| `services::discord::tui_prompt_relay::synthetic_start` | `src/services/discord/tui_prompt_relay/synthetic_start.rs` | 2436 | 1094 | 1342 | giant-file |
...
| `services::discord::turn_bridge::terminal_outcome_delivery` | `src/services/discord/turn_bridge/terminal_outcome_delivery.rs` | 916 | 916 | 0 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2904 | 2078 | 826 | giant-file |
...
| `services::tui_steering` | `src/services/tui_steering.rs` | 232 | 130 | 102 |  |
