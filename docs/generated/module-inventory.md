...
| `server` | `src/server/mod.rs` | 3362 | 2756 | 606 | giant-file |
...
| `server::routes::agents_crud` | `src/server/routes/agents_crud.rs` | 1295 | 1295 | 0 | giant-file |
...
| `services::cluster::intake_worker` | `src/services/cluster/intake_worker.rs` | 693 | 507 | 186 |  |
...
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 2415 | 978 | 1437 |  |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 2166 | 981 | 1185 |  |
...
| `services::discord::relay_recovery_auto_heal_apply` | `src/services/discord/relay_recovery_auto_heal_apply.rs` | 729 | 310 | 419 |  |
...
| `services::discord::relay_recovery_circuit_breaker` | `src/services/discord/relay_recovery_circuit_breaker.rs` | 2410 | 960 | 1450 |  |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1664 | 916 | 748 |  |
...
| `services::discord::turn_bridge::retry_state` | `src/services/discord/turn_bridge/retry_state.rs` | 886 | 421 | 465 |  |
...
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 1134 | 850 | 284 |  |
...
| `services::qwen` | `src/services/qwen.rs` | 2213 | 2192 | 21 | giant-file |
