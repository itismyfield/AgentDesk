...
| `cli` | `src/cli/mod.rs` | 23 | 23 | 0 |  |
| `cli::args` | `src/cli/args.rs` | 1082 | 954 | 128 |  |
...
| `cli::run` | `src/cli/run.rs` | 835 | 788 | 47 |  |
...
| `server::routes` | `src/server/routes/mod.rs` | 568 | 333 | 235 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5803 | 601 | 5202 |  |
...
| `services::discord::readopted_mailbox_ledger` | `src/services/discord/readopted_mailbox_ledger.rs` | 151 | 151 | 0 |  |
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 505 | 449 | 56 |  |
...
| `services::discord::recovery_engine::manual_rebind` | `src/services/discord/recovery_engine/manual_rebind/mod.rs` | 1229 | 804 | 425 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4773 | 1681 | 3092 | giant-file |
...
| `services::discord::session_relay_sink::task_notification_context` | `src/services/discord/session_relay_sink/task_notification_context.rs` | 755 | 466 | 289 |  |
...
| `services::discord::task_notification_delivery` | `src/services/discord/task_notification_delivery/mod.rs` | 987 | 987 | 0 |  |
| `services::discord::task_notification_delivery::gateway` | `src/services/discord/task_notification_delivery/gateway.rs` | 165 | 151 | 14 |  |
| `services::discord::task_notification_delivery::response_chunks` | `src/services/discord/task_notification_delivery/response_chunks.rs` | 629 | 592 | 37 |  |
| `services::discord::task_notification_delivery::store` | `src/services/discord/task_notification_delivery/store.rs` | 870 | 870 | 0 |  |
| `services::discord::task_notification_delivery::store::missing_card_replacement` | `src/services/discord/task_notification_delivery/store/missing_card_replacement.rs` | 188 | 188 | 0 |  |
...
| `services::discord::task_notification_delivery::store::response_fence` | `src/services/discord/task_notification_delivery/store/response_fence.rs` | 761 | 761 | 0 |  |
...
| `services::discord::tmux_watcher::streaming_status_tick` | `src/services/discord/tmux_watcher/streaming_status_tick.rs` | 962 | 962 | 0 |  |
| `services::discord::tmux_watcher::supervisor_relay` | `src/services/discord/tmux_watcher/supervisor_relay.rs` | 619 | 619 | 0 |  |
| `services::discord::tmux_watcher::task_response_authority` | `src/services/discord/tmux_watcher/task_response_authority.rs` | 459 | 459 | 0 |  |
...
| `services::discord::tmux_watcher::terminal_direct_fallback` | `src/services/discord/tmux_watcher/terminal_direct_fallback.rs` | 674 | 670 | 4 |  |
...
| `services::discord::turn_bridge::panel_lifecycle` | `src/services/discord/turn_bridge/panel_lifecycle.rs` | 247 | 247 | 0 |  |
...
| `services::discord::turn_bridge::stream_tick` | `src/services/discord/turn_bridge/stream_tick.rs` | 876 | 755 | 121 |  |
