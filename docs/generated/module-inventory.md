...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 5893 | 2567 | 3326 | giant-file |
...
| `services::discord::health::relay_auto_heal` | `src/services/discord/health/relay_auto_heal.rs` | 1968 | 721 | 1247 |  |
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 277 | 101 | 176 |  |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 1274 | 994 | 280 |  |
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 2416 | 979 | 1437 |  |
| `services::discord::health::stall_liveness::redrive_grace` | `src/services/discord/health/stall_liveness/redrive_grace.rs` | 651 | 258 | 393 |  |
| `services::discord::health::stall_verdict` | `src/services/discord/health/stall_verdict.rs` | 1351 | 425 | 926 |  |
| `services::discord::health::watcher_respawn` | `src/services/discord/health/watcher_respawn.rs` | 1391 | 627 | 764 |  |
...
| `services::discord::mailbox_finish` | `src/services/discord/mailbox_finish.rs` | 188 | 188 | 0 |  |
...
| `services::discord::recovery_engine::restore_inflight` | `src/services/discord/recovery_engine/restore_inflight.rs` | 2395 | 2326 | 69 | giant-file |
...
| `services::discord::relay_recovery_circuit_breaker` | `src/services/discord/relay_recovery_circuit_breaker.rs` | 1682 | 717 | 965 |  |
...
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 640 | 283 | 357 |  |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1849 | 1442 | 407 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3112 | 2689 | 423 | giant-file |
...
| `services::discord::tmux_watcher::turn_stream_collector` | `src/services/discord/tmux_watcher/turn_stream_collector.rs` | 1159 | 1159 | 0 | giant-file |
...
| `services::discord::tui_prompt_relay::synthetic_start` | `src/services/discord/tui_prompt_relay/synthetic_start.rs` | 2421 | 1084 | 1337 | giant-file |
...
| `services::discord::turn_bridge::completion_postlude` | `src/services/discord/turn_bridge/completion_postlude.rs` | 956 | 956 | 0 |  |
| `services::discord::turn_bridge::completion_postlude::channel_writeback` | `src/services/discord/turn_bridge/completion_postlude/channel_writeback.rs` | 201 | 81 | 120 |  |
