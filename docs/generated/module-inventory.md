...
| `services::agent_quality::regression_alerts` | `src/services/agent_quality/regression_alerts.rs` | 678 | 497 | 181 |  |
...
| `services::auto_queue::planning` | `src/services/auto_queue/planning.rs` | 536 | 322 | 214 |  |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1413 | 951 | 462 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5946 | 591 | 5355 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 624 | 624 | 0 |  |
...
| `services::discord::placeholder_live_events::completion_footer` | `src/services/discord/placeholder_live_events/completion_footer.rs` | 460 | 460 | 0 |  |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 1299 | 757 | 542 |  |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 912 | 589 | 323 |  |
