...
| `db::schema` | `src/db/schema.rs` | 2949 | giant-file |
...
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1658 | giant-file |
...
| `server::routes` | `src/server/routes/mod.rs` | 228 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 2360 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 2376 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2836 | giant-file |
...
| `services::discord::monitoring_status` | `src/services/discord/monitoring_status.rs` | 288 |  |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 5177 | giant-file |
| `services::discord::router::thread_binding` | `src/services/discord/router/thread_binding.rs` | 129 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 1764 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6841 | giant-file |
...
| `services::observability` | `src/services/observability.rs` | 1363 | giant-file |
