...
| `dispatch` | `src/dispatch/mod.rs` | 57 | 57 | 0 |  |
...
| `dispatch::dispatch_context` | `src/dispatch/dispatch_context.rs` | 3985 | 2852 | 1133 | giant-file |
| `dispatch::dispatch_create` | `src/dispatch/dispatch_create.rs` | 1526 | 1396 | 130 | giant-file |
| `dispatch::dispatch_query` | `src/dispatch/dispatch_query.rs` | 89 | 89 | 0 |  |
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1716 | 1529 | 187 | giant-file |
...
| `engine` | `src/engine/mod.rs` | 1356 | 1280 | 76 | giant-file |
| `engine::hooks` | `src/engine/hooks.rs` | 84 | 84 | 0 |  |
| `engine::intent` | `src/engine/intent.rs` | 578 | 556 | 22 |  |
| `engine::loader` | `src/engine/loader.rs` | 2013 | 1332 | 681 | giant-file |
| `engine::ops` | `src/engine/ops.rs` | 99 | 99 | 0 |  |
...
| `engine::ops::dispatch_ops` | `src/engine/ops/dispatch_ops.rs` | 365 | 365 | 0 |  |
...
| `engine::ops::kanban_ops` | `src/engine/ops/kanban_ops.rs` | 1551 | 953 | 598 |  |
...
| `engine::ops::runtime_ops` | `src/engine/ops/runtime_ops.rs` | 276 | 276 | 0 |  |
...
| `kanban::terminal_cleanup` | `src/kanban/terminal_cleanup.rs` | 391 | 391 | 0 |  |
| `kanban::transition_cleanup` | `src/kanban/transition_cleanup.rs` | 341 | 341 | 0 |  |
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 682 | 682 | 0 |  |
...
| `pipeline` | `src/pipeline.rs` | 1543 | 1409 | 134 | giant-file |
...
| `server::routes::docs::inventory::endpoints::part_01` | `src/server/routes/docs/inventory/endpoints/part_01.rs` | 680 | 680 | 0 |  |
| `server::routes::docs::inventory::endpoints::part_02` | `src/server/routes/docs/inventory/endpoints/part_02.rs` | 641 | 641 | 0 |  |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2391 | 1670 | 721 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 2740 | 2677 | 63 | giant-file |
...
| `server::routes::routines::handlers` | `src/server/routes/routines/handlers.rs` | 495 | 495 | 0 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1504 | 1267 | 237 | giant-file |
...
| `services::cluster::stream_relay` | `src/services/cluster/stream_relay.rs` | 1634 | 981 | 653 |  |
...
| `services::codex` | `src/services/codex.rs` | 3758 | 3049 | 709 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5306 | 4155 | 1151 | giant-file |
...
| `services::discord::commands::node` | `src/services/discord/commands/node.rs` | 480 | 451 | 29 |  |
...
| `services::discord::controller_rollout_flag` | `src/services/discord/controller_rollout_flag.rs` | 131 | 70 | 61 |  |
| `services::discord::delivery_lease_key` | `src/services/discord/delivery_lease_key.rs` | 152 | 152 | 0 |  |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1236 | 998 | 238 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 4227 | 2498 | 1729 | giant-file |
...
| `services::discord::health::watcher_respawn` | `src/services/discord/health/watcher_respawn.rs` | 1095 | 497 | 598 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 6422 | 931 | 5491 |  |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1177 | 861 | 316 |  |
...
| `services::discord::inflight::save_store` | `src/services/discord/inflight/save_store.rs` | 654 | 569 | 85 |  |
| `services::discord::inflight::store` | `src/services/discord/inflight/store.rs` | 305 | 305 | 0 |  |
...
| `services::discord::monitoring_status` | `src/services/discord/monitoring_status.rs` | 384 | 384 | 0 |  |
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 57 | 57 | 0 |  |
...
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 2365 | 971 | 1394 |  |
...
| `services::discord::outbound::send_api` | `src/services/discord/outbound/send_api.rs` | 606 | 306 | 300 |  |
| `services::discord::outbound::send_gate` | `src/services/discord/outbound/send_gate.rs` | 649 | 443 | 206 |  |
...
| `services::discord::outbound::turn_output_controller_rollout_health` | `src/services/discord/outbound/turn_output_controller_rollout_health.rs` | 256 | 128 | 128 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 695 | 695 | 0 |  |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 1045 | 585 | 460 |  |
...
| `services::discord::reaction_lifecycle` | `src/services/discord/reaction_lifecycle.rs` | 329 | 287 | 42 |  |
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 3442 | 3034 | 408 | giant-file |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 1801 | 888 | 913 |  |
| `services::discord::recovery_engine::routing_orphan` | `src/services/discord/recovery_engine/routing_orphan.rs` | 218 | 146 | 72 |  |
| `services::discord::recovery_engine::runtime` | `src/services/discord/recovery_engine/runtime.rs` | 357 | 137 | 220 |  |
...
| `services::discord::recovery_engine::terminal_text_idempotency` | `src/services/discord/recovery_engine/terminal_text_idempotency.rs` | 863 | 431 | 432 |  |
| `services::discord::recovery_engine::terminal_watcher` | `src/services/discord/recovery_engine/terminal_watcher.rs` | 195 | 148 | 47 |  |
| `services::discord::recovery_paths` | `src/services/discord/recovery_paths/mod.rs` | 36 | 36 | 0 |  |
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 717 | 303 | 414 |  |
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 1342 | 864 | 478 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 2727 | 1287 | 1440 | giant-file |
...
| `services::discord::replace_outcome_policy` | `src/services/discord/replace_outcome_policy.rs` | 264 | 138 | 126 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1649 | 1611 | 38 | giant-file |
...
| `services::discord::router::intake_gate::queue_effects` | `src/services/discord/router/intake_gate/queue_effects.rs` | 943 | 735 | 208 |  |
| `services::discord::router::intake_gate::reaction_remove` | `src/services/discord/router/intake_gate/reaction_remove.rs` | 226 | 226 | 0 |  |
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 557 | 273 | 284 |  |
| `services::discord::router::intake_queue_transaction` | `src/services/discord/router/intake_queue_transaction.rs` | 829 | 471 | 358 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 2861 | 2814 | 47 | giant-file |
| `services::discord::router::message_handler::intake_turn::race_loss` | `src/services/discord/router/message_handler/intake_turn/race_loss.rs` | 615 | 581 | 34 |  |
...
| `services::discord::router::turn_start` | `src/services/discord/router/turn_start.rs` | 418 | 418 | 0 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 893 | 301 | 592 |  |
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 346 | 322 | 24 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 252 | 252 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4308 | 1698 | 2610 | giant-file |
...
| `services::discord::session_runtime::worktree` | `src/services/discord/session_runtime/worktree.rs` | 606 | 606 | 0 |  |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1692 | 915 | 777 |  |
...
| `services::discord::status_panel_timedout_reconcile` | `src/services/discord/status_panel_timedout_reconcile.rs` | 406 | 406 | 0 |  |
...
| `services::discord::terminal_ui_obligation` | `src/services/discord/terminal_ui_obligation.rs` | 718 | 647 | 71 |  |
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2251 | 1507 | 744 | giant-file |
...
| `services::discord::tmux_watcher::session_bound_ack` | `src/services/discord/tmux_watcher/session_bound_ack.rs` | 455 | 455 | 0 |  |
...
| `services::discord::tmux_watcher::supervisor_relay` | `src/services/discord/tmux_watcher/supervisor_relay.rs` | 612 | 612 | 0 |  |
| `services::discord::tmux_watcher::terminal_long_chunks` | `src/services/discord/tmux_watcher/terminal_long_chunks.rs` | 294 | 294 | 0 |  |
| `services::discord::tmux_watcher::terminal_readiness` | `src/services/discord/tmux_watcher/terminal_readiness.rs` | 235 | 235 | 0 |  |
| `services::discord::tmux_watcher::terminal_send` | `src/services/discord/tmux_watcher/terminal_send.rs` | 681 | 635 | 46 |  |
| `services::discord::tmux_watcher::turn_identity` | `src/services/discord/tmux_watcher/turn_identity.rs` | 426 | 426 | 0 |  |
| `services::discord::tmux_watcher::two_message_panel` | `src/services/discord/tmux_watcher/two_message_panel.rs` | 692 | 380 | 312 |  |
| `services::discord::tmux_watcher::utf8_chunk_decoder` | `src/services/discord/tmux_watcher/utf8_chunk_decoder.rs` | 88 | 88 | 0 |  |
| `services::discord::tui_busy_gate` | `src/services/discord/tui_busy_gate.rs` | 157 | 121 | 36 |  |
...
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 3809 | 1490 | 2319 | giant-file |
...
| `services::discord::tui_prompt_relay::claude_idle_bridge` | `src/services/discord/tui_prompt_relay/claude_idle_bridge.rs` | 662 | 662 | 0 |  |
...
| `services::discord::tui_prompt_relay_controller_cutover` | `src/services/discord/tui_prompt_relay_controller_cutover.rs` | 983 | 239 | 744 |  |
| `services::discord::tui_task_card` | `src/services/discord/tui_task_card.rs` | 1861 | 1065 | 796 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6684 | 6261 | 423 | giant-file |
...
| `services::discord::turn_bridge::completion_guard::completion_postgres` | `src/services/discord/turn_bridge/completion_guard/completion_postgres.rs` | 647 | 551 | 96 |  |
| `services::discord::turn_bridge::context_window` | `src/services/discord/turn_bridge/context_window.rs` | 170 | 100 | 70 |  |
| `services::discord::turn_bridge::early_tui_completion` | `src/services/discord/turn_bridge/early_tui_completion.rs` | 96 | 96 | 0 |  |
| `services::discord::turn_bridge::finalize_epilogue` | `src/services/discord/turn_bridge/finalize_epilogue.rs` | 324 | 156 | 168 |  |
...
| `services::discord::turn_bridge::single_message_footer` | `src/services/discord/turn_bridge/single_message_footer.rs` | 780 | 595 | 185 |  |
...
| `services::discord::turn_bridge::status_panel` | `src/services/discord/turn_bridge/status_panel.rs` | 660 | 660 | 0 |  |
...
| `services::discord::turn_bridge::terminal_controller_cutover` | `src/services/discord/turn_bridge/terminal_controller_cutover.rs` | 1926 | 991 | 935 |  |
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1814 | 682 | 1132 |  |
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 1019 | 968 | 51 |  |
...
| `services::discord::turn_bridge::two_message_panel` | `src/services/discord/turn_bridge/two_message_panel.rs` | 809 | 265 | 544 |  |
...
| `services::discord::turn_finalizer::finalize` | `src/services/discord/turn_finalizer/finalize.rs` | 523 | 252 | 271 |  |
| `services::discord::turn_finalizer::finalize_context` | `src/services/discord/turn_finalizer/finalize_context.rs` | 119 | 119 | 0 |  |
| `services::discord::turn_finalizer::reconcile` | `src/services/discord/turn_finalizer/reconcile.rs` | 221 | 221 | 0 |  |
| `services::discord::turn_finalizer::watcher_backstop` | `src/services/discord/turn_finalizer/watcher_backstop.rs` | 173 | 121 | 52 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 5148 | 2905 | 2243 | giant-file |
...
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 455 | 455 | 0 |  |
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1290 | 1182 | 108 | giant-file |
...
| `services::escalation_settings` | `src/services/escalation_settings.rs` | 166 | 135 | 31 |  |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 826 | 651 | 175 |  |
...
| `services::queue` | `src/services/queue.rs` | 954 | 876 | 78 |  |
...
| `services::review_decision::repo_card` | `src/services/review_decision/repo_card.rs` | 855 | 746 | 109 |  |
...
| `services::tui_turn_state` | `src/services/tui_turn_state.rs` | 2032 | 647 | 1385 |  |
| `services::tui_turn_state::completion_scan` | `src/services/tui_turn_state/completion_scan.rs` | 429 | 429 | 0 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 6365 | 2959 | 3406 | giant-file |
| `services::turn_orchestrator::dispatch_reservation` | `src/services/turn_orchestrator/dispatch_reservation.rs` | 431 | 431 | 0 |  |
| `services::turn_orchestrator::pending_queue_persistence` | `src/services/turn_orchestrator/pending_queue_persistence.rs` | 609 | 609 | 0 |  |
