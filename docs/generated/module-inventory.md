...
| `services::discord` | `src/services/discord/mod.rs` | 5507 | 4124 | 1383 | giant-file |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 2450 | 1402 | 1048 | giant-file |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 5489 | 2717 | 2772 | giant-file |
...
| `services::discord::health::relay_auto_heal` | `src/services/discord/health/relay_auto_heal.rs` | 533 | 290 | 243 |  |
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 267 | 100 | 167 |  |
...
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 1872 | 768 | 1104 |  |
...
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 620 | 273 | 347 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7361 | 7361 | 0 | giant-file |
...
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 4844 | 1048 | 3796 | giant-file |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 7125 | 3292 | 3833 | giant-file |
...
| `services::turn_orchestrator::pending_queue_persistence` | `src/services/turn_orchestrator/pending_queue_persistence.rs` | 703 | 703 | 0 |  |
