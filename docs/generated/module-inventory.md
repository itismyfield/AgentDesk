...
| `services::claude` | `src/services/claude.rs` | 3998 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 9566 | giant-file |
