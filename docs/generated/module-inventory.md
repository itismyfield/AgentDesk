...
| `kanban` | `src/kanban/mod.rs` | 13 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 3054 | giant-file |
| `kanban::test_support` | `src/kanban/test_support.rs` | 484 |  |
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 512 |  |
