...
| --- | --- | ---: | --- |
| `bootstrap` | `src/bootstrap.rs` | 62 |  |
| `cli` | `src/cli/mod.rs` | 20 |  |
| `cli::args` | `src/cli/args.rs` | 939 |  |
| `cli::client` | `src/cli/client.rs` | 1654 | giant-file |
...
| `db::dispatches` | `src/db/dispatches/mod.rs` | 990 |  |
...
| `server::dto::dispatches` | `src/server/dto/dispatches.rs` | 351 |  |
...
| `server::routes::dispatches` | `src/server/routes/dispatches/mod.rs` | 98 |  |
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 483 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5295 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 294 |  |
...
| `services::analytics` | `src/services/analytics.rs` | 19 |  |
| `services::analytics::api_usage` | `src/services/analytics/api_usage.rs` | 203 |  |
| `services::analytics::dispatch_metrics` | `src/services/analytics/dispatch_metrics.rs` | 269 |  |
| `services::analytics::queue_metrics` | `src/services/analytics/queue_metrics.rs` | 569 |  |
| `services::analytics::session_metrics` | `src/services/analytics/session_metrics.rs` | 120 |  |
| `services::api_friction` | `src/services/api_friction.rs` | 1709 | giant-file |
| `services::auto_queue` | `src/services/auto_queue.rs` | 1457 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5937 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7313 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6316 | giant-file |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 1979 | giant-file |
...
| `services::dispatches::discord_delivery::guard` | `src/services/dispatches/discord_delivery/guard.rs` | 132 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2493 | giant-file |
