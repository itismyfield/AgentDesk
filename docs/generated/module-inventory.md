...
| `server` | `src/server/mod.rs` | 3076 | 2666 | 410 | giant-file |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2349 | 1658 | 691 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 2738 | 2675 | 63 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5297 | 4146 | 1151 | giant-file |
...
| `services::discord::discord_io` | `src/services/discord/discord_io.rs` | 532 | 532 | 0 |  |
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 52 | 52 | 0 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 3425 | 3017 | 408 | giant-file |
...
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 663 | 278 | 385 |  |
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 1341 | 863 | 478 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1643 | 1605 | 38 | giant-file |
...
| `services::discord::router::turn_start` | `src/services/discord/router/turn_start.rs` | 417 | 417 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4272 | 1679 | 2593 | giant-file |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1638 | 890 | 748 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2245 | 1501 | 744 | giant-file |
...
| `services::discord::tmux_reaper` | `src/services/discord/tmux_reaper.rs` | 781 | 676 | 105 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7291 | 7291 | 0 | giant-file |
...
| `services::discord::tmux_watcher::terminal_send` | `src/services/discord/tmux_watcher/terminal_send.rs` | 614 | 568 | 46 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6636 | 6213 | 423 | giant-file |
...
| `services::discord::turn_bridge::recovery_text` | `src/services/discord/turn_bridge/recovery_text.rs` | 588 | 484 | 104 |  |
...
| `services::discord::turn_bridge::terminal_controller_cutover` | `src/services/discord/turn_bridge/terminal_controller_cutover.rs` | 1847 | 950 | 897 |  |
...
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 1569 | 606 | 963 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2842 | 2052 | 790 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 1733 | 1546 | 187 | giant-file |
...
| `services::dispatches::discord_delivery::orchestration` | `src/services/dispatches/discord_delivery/orchestration.rs` | 1517 | 1496 | 21 | giant-file |
| `services::dispatches::discord_delivery::thread_reuse` | `src/services/dispatches/discord_delivery/thread_reuse.rs` | 772 | 772 | 0 |  |
| `services::dispatches::discord_delivery::transport` | `src/services/dispatches/discord_delivery/transport.rs` | 1095 | 854 | 241 |  |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1280 | 1172 | 108 | giant-file |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 689 | 514 | 175 |  |
