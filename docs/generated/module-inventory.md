...
| `cli::client` | `src/cli/client.rs` | 1512 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 2984 | giant-file |
...
| `engine::ops::exec_ops` | `src/engine/ops/exec_ops.rs` | 369 |  |
...
| `engine::ops::pipeline_ops` | `src/engine/ops/pipeline_ops.rs` | 207 |  |
...
| `kanban` | `src/kanban.rs` | 1959 | giant-file |
...
| `server` | `src/server/mod.rs` | 1437 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 6148 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 3395 | giant-file |
...
| `server::routes::onboarding` | `src/server/routes/onboarding.rs` | 4294 | giant-file |
...
| `services::claude` | `src/services/claude.rs` | 2277 | giant-file |
| `services::codex` | `src/services/codex.rs` | 1481 | giant-file |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 525 |  |
| `services::discord` | `src/services/discord/mod.rs` | 2098 | giant-file |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 281 |  |
| `services::discord::handoff` | `src/services/discord/handoff.rs` | 260 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 2092 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2327 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2977 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 1957 | giant-file |
...
| `services::memory::memento` | `src/services/memory/memento.rs` | 1847 | giant-file |
...
| `services::platform::shell` | `src/services/platform/shell.rs` | 1177 | giant-file |
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 178 |  |
| `services::process` | `src/services/process.rs` | 701 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2007 | giant-file |
