...
| `server` | `src/server/mod.rs` | 3216 | 2806 | 410 | giant-file |
...
| `server::routes` | `src/server/routes/mod.rs` | 567 | 332 | 235 |  |
...
| `services` | `src/services/mod.rs` | 130 | 130 | 0 |  |
...
| `services::claude` | `src/services/claude.rs` | 4313 | 2960 | 1353 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5371 | 4117 | 1254 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3846 | 2854 | 992 | giant-file |
...
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 1517 | 638 | 879 |  |
| `services::discord::health::watcher_respawn` | `src/services/discord/health/watcher_respawn.rs` | 1381 | 627 | 754 |  |
...
| `services::discord::inflight::save_store` | `src/services/discord/inflight/save_store.rs` | 892 | 807 | 85 |  |
...
| `services::discord::mailbox_finish` | `src/services/discord/mailbox_finish.rs` | 88 | 88 | 0 |  |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 1897 | 715 | 1182 |  |
| `services::discord::queue_marker` | `src/services/discord/queue_marker.rs` | 621 | 194 | 427 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 484 | 428 | 56 |  |
...
| `services::discord::recovery_engine::manual_rebind` | `src/services/discord/recovery_engine/manual_rebind.rs` | 1865 | 985 | 880 |  |
...
| `services::discord::recovery_engine::restore_inflight` | `src/services/discord/recovery_engine/restore_inflight.rs` | 2395 | 2304 | 91 | giant-file |
...
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 648 | 278 | 370 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 3361 | 1505 | 1856 | giant-file |
...
| `services::discord::router::intake_queue_transaction` | `src/services/discord/router/intake_queue_transaction.rs` | 831 | 473 | 358 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 2976 | 2825 | 151 | giant-file |
| `services::discord::router::message_handler::intake_turn::race_loss` | `src/services/discord/router/message_handler/intake_turn/race_loss.rs` | 699 | 609 | 90 |  |
...
| `services::discord::router::response_format` | `src/services/discord/router/response_format.rs` | 359 | 335 | 24 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4731 | 1664 | 3067 | giant-file |
| `services::discord::session_relay_sink::idle_jsonl` | `src/services/discord/session_relay_sink/idle_jsonl.rs` | 410 | 387 | 23 |  |
| `services::discord::session_relay_sink::orphan_reclaim` | `src/services/discord/session_relay_sink/orphan_reclaim.rs` | 427 | 123 | 304 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2218 | 1484 | 734 | giant-file |
...
| `services::discord::tmux_placeholder_suppression` | `src/services/discord/tmux_placeholder_suppression.rs` | 1256 | 693 | 563 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7250 | 7250 | 0 | giant-file |
...
| `services::discord::tmux_watcher::terminal_readiness` | `src/services/discord/tmux_watcher/terminal_readiness.rs` | 273 | 273 | 0 |  |
...
| `services::discord::tui_direct_abort_marker` | `src/services/discord/tui_direct_abort_marker/mod.rs` | 3318 | 1233 | 2085 | giant-file |
...
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 3811 | 1492 | 2319 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6583 | 6160 | 423 | giant-file |
...
| `services::discord::turn_bridge::retry_state` | `src/services/discord/turn_bridge/retry_state.rs` | 746 | 381 | 365 |  |
...
| `services::discord::turn_bridge::terminal_controller_cutover` | `src/services/discord/turn_bridge/terminal_controller_cutover.rs` | 1830 | 960 | 870 |  |
...
| `services::discord::turn_bridge::two_message_panel` | `src/services/discord/turn_bridge/two_message_panel.rs` | 791 | 265 | 526 |  |
...
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 4778 | 1048 | 3730 | giant-file |
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 1532 | 569 | 963 |  |
...
| `services::queue` | `src/services/queue.rs` | 956 | 876 | 80 |  |
...
| `services::tmux_wrapper` | `src/services/tmux_wrapper.rs` | 769 | 726 | 43 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 6894 | 3175 | 3719 | giant-file |
| `services::turn_orchestrator::active_source_dedup` | `src/services/turn_orchestrator/active_source_dedup.rs` | 115 | 115 | 0 |  |
