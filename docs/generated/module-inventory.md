...
| --- | --- | ---: | --- |
| `bootstrap` | `src/bootstrap.rs` | 69 |  |
| `cli` | `src/cli/mod.rs` | 20 |  |
| `cli::args` | `src/cli/args.rs` | 1002 | giant-file |
...
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 4606 | giant-file |
...
| `config` | `src/config.rs` | 3063 | giant-file |
| `crate` | `src/main.rs` | 49 |  |
| `credential` | `src/credential.rs` | 180 |  |
| `db` | `src/db/mod.rs` | 344 |  |
...
| `db::auto_queue::phase_gates` | `src/db/auto_queue/phase_gates.rs` | 2140 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 1708 | giant-file |
...
| `server` | `src/server/mod.rs` | 3843 | giant-file |
| `server::cluster` | `src/server/cluster.rs` | 1190 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 173 |  |
| `server::routes::automation_candidates` | `src/server/routes/automation_candidates.rs` | 330 |  |
| `server::routes::cluster` | `src/server/routes/cluster.rs` | 409 |  |
...
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 1009 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5982 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 328 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 900 |  |
| `server::ws` | `src/server/ws.rs` | 277 |  |
| `services` | `src/services/mod.rs` | 73 |  |
...
| `services::auto_queue::route_types` | `src/services/auto_queue/route_types.rs` | 146 |  |
...
| `services::claude` | `src/services/claude.rs` | 3604 | giant-file |
| `services::claude_tui` | `src/services/claude_tui/mod.rs` | 6 |  |
| `services::claude_tui::hook_bundle` | `src/services/claude_tui/hook_bundle.rs` | 136 |  |
| `services::claude_tui::hook_relay` | `src/services/claude_tui/hook_relay.rs` | 260 |  |
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 407 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 400 |  |
| `services::claude_tui::session` | `src/services/claude_tui/session.rs` | 270 |  |
| `services::claude_tui::transcript_tail` | `src/services/claude_tui/transcript_tail.rs` | 258 |  |
...
| `services::codex` | `src/services/codex.rs` | 1801 | giant-file |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 734 |  |
| `services::discord` | `src/services/discord/mod.rs` | 6191 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5122 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1382 | giant-file |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 593 |  |
| `services::discord::queued_placeholders_store` | `src/services/discord/queued_placeholders_store.rs` | 412 |  |
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5079 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2581 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7998 | giant-file |
| `services::discord::router::response_format` | `src/services/discord/router/response_format.rs` | 345 |  |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3161 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4705 | giant-file |
...
| `services::discord::voice_background_driver` | `src/services/discord/voice_background_driver.rs` | 289 |  |
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 2593 | giant-file |
...
| `services::git` | `src/services/git/mod.rs` | 87 |  |
...
| `services::memory::memento` | `src/services/memory/memento.rs` | 2728 | giant-file |
...
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 376 |  |
| `services::process` | `src/services/process.rs` | 706 |  |
| `services::provider` | `src/services/provider.rs` | 2343 | giant-file |
...
| `services::provider_hosting` | `src/services/provider_hosting.rs` | 244 |  |
...
| `services::session_backend` | `src/services/session_backend.rs` | 1269 | giant-file |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 755 |  |
...
| `voice` | `src/voice/mod.rs` | 14 |  |
| `voice::barge_in` | `src/voice/barge_in.rs` | 823 |  |
| `voice::commands` | `src/voice/commands.rs` | 835 |  |
| `voice::config` | `src/voice/config.rs` | 498 |  |
| `voice::metrics` | `src/voice/metrics.rs` | 301 |  |
| `voice::progress` | `src/voice/progress.rs` | 445 |  |
| `voice::prompt` | `src/voice/prompt.rs` | 419 |  |
| `voice::receiver` | `src/voice/receiver.rs` | 889 |  |
