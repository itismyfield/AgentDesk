...
| `services` | `src/services/mod.rs` | 140 | 140 | 0 |  |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 1359 | 841 | 518 |  |
...
| `services::routines` | `src/services/routines/mod.rs` | 34 | 34 | 0 |  |
