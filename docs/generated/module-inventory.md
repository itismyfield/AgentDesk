...
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 996 |  |
...
| `services::auto_queue::route_generate` | `src/services/auto_queue/route_generate.rs` | 430 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5590 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 4533 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1256 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 3645 | giant-file |
