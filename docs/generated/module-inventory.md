...
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 4686 | giant-file |
...
| `services` | `src/services/mod.rs` | 63 |  |
...
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1273 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4259 | giant-file |
...
| `services::discord_delivery` | `src/services/discord_delivery.rs` | 441 |  |
