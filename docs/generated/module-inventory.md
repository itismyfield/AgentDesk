...
| `dispatch::dispatch_create` | `src/dispatch/dispatch_create.rs` | 2094 | giant-file |
...
| `services::discord::tmux_restart_handoff` | `src/services/discord/tmux_restart_handoff.rs` | 423 |  |
