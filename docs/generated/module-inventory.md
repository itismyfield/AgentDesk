...
| `services::claude` | `src/services/claude.rs` | 4397 | 2966 | 1431 | giant-file |
...
| `services::discord::turn_bridge::tmux_runtime::claude_stop_delivery` | `src/services/discord/turn_bridge/tmux_runtime/claude_stop_delivery.rs` | 835 | 502 | 333 |  |
...
| `services::provider` | `src/services/provider.rs` | 2428 | 1814 | 614 | giant-file |
| `services::provider::cancel_token_claude_interrupt` | `src/services/provider/cancel_token_claude_interrupt.rs` | 139 | 89 | 50 |  |
