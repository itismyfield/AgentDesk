...
| `config` | `src/config.rs` | 2759 | 2523 | 236 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 2253 | 1116 | 1137 | giant-file |
...
| `reconcile` | `src/reconcile.rs` | 2781 | 1818 | 963 | giant-file |
...
| `services::cluster::session_discovery` | `src/services/cluster/session_discovery.rs` | 1041 | 586 | 455 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 4923 | 4106 | 817 | giant-file |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 876 | 857 | 19 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 7193 | 3108 | 4085 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4151 | 3436 | 715 | giant-file |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 1847 | 1022 | 825 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 3481 | 2977 | 504 | giant-file |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 3496 | 1633 | 1863 | giant-file |
