...
| `db::dispatches` | `src/db/dispatches/mod.rs` | 985 |  |
...
| `server` | `src/server/mod.rs` | 3554 | giant-file |
...
| `server::dto::agents` | `src/server/dto/agents.rs` | 263 |  |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1543 | giant-file |
...
| `server::routes::dispatches` | `src/server/routes/dispatches/mod.rs` | 105 |  |
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 444 |  |
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 1678 | giant-file |
| `server::routes::dispatches::outbox` | `src/server/routes/dispatches/outbox.rs` | 41 |  |
...
| `services::agents::query` | `src/services/agents/query.rs` | 548 |  |
| `services::agents::turn` | `src/services/agents/turn.rs` | 447 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 7170 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7197 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4504 | giant-file |
...
| `services::dispatches::discord_delivery` | `src/services/dispatches/discord_delivery.rs` | 871 |  |
| `services::dispatches::outbox_claiming` | `src/services/dispatches/outbox_claiming.rs` | 195 |  |
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 588 |  |
