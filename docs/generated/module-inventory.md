...
| `services::discord` | `src/services/discord/mod.rs` | 5143 | 4155 | 988 | giant-file |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3673 | 2236 | 1437 | giant-file |
...
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 264 | 100 | 164 |  |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 985 | 874 | 111 |  |
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 1572 | 662 | 910 |  |
...
| `services::discord::reaction_lifecycle` | `src/services/discord/reaction_lifecycle.rs` | 312 | 270 | 42 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1632 | 1594 | 38 | giant-file |
...
| `services::discord::router::intake_gate::queue_effects` | `src/services/discord/router/intake_gate/queue_effects.rs` | 909 | 721 | 188 |  |
| `services::discord::router::intake_gate::reaction_remove` | `src/services/discord/router/intake_gate/reaction_remove.rs` | 226 | 226 | 0 |  |
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 542 | 260 | 282 |  |
...
| `services::discord::router::message_handler::tui_followup` | `src/services/discord/router/message_handler/tui_followup.rs` | 905 | 809 | 96 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7260 | 7260 | 0 | giant-file |
...
| `services::discord::tmux_watcher::turn_identity` | `src/services/discord/tmux_watcher/turn_identity.rs` | 341 | 341 | 0 |  |
...
| `services::discord::tui_prompt_relay::codex_idle_rollout` | `src/services/discord/tui_prompt_relay/codex_idle_rollout.rs` | 609 | 609 | 0 |  |
...
| `services::discord::turn_bridge::finalize_epilogue` | `src/services/discord/turn_bridge/finalize_epilogue.rs` | 137 | 137 | 0 |  |
...
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 1495 | 569 | 926 |  |
...
| `services::discord::turn_finalizer::finalize` | `src/services/discord/turn_finalizer/finalize.rs` | 377 | 249 | 128 |  |
