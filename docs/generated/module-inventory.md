...
| `db::dispatches::outbox` | `src/db/dispatches/outbox.rs` | 38 |  |
...
| `server::dto::dispatches` | `src/server/dto/dispatches.rs` | 20 |  |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 456 |  |
