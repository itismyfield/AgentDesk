...
| `kanban` | `src/kanban/mod.rs` | 18 |  |
| `kanban::hooks` | `src/kanban/hooks.rs` | 493 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 1913 | giant-file |
...
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 429 |  |
