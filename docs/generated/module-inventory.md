...
| `cli::client` | `src/cli/client.rs` | 1532 | giant-file |
...
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 2876 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 790 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 1874 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 3186 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 1738 | giant-file |
