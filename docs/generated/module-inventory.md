...
| `services::claude_tui::hosting::followup_support` | `src/services/claude_tui/hosting/followup_support.rs` | 519 | 404 | 115 |  |
...
| `services::discord::queue_marker` | `src/services/discord/queue_marker.rs` | 642 | 214 | 428 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1655 | 1586 | 69 | giant-file |
...
| `services::discord::router::intake_gate::queue_effects` | `src/services/discord/router/intake_gate/queue_effects.rs` | 1272 | 837 | 435 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3193 | 2839 | 354 | giant-file |
...
| `services::discord::router::queue_status_presentation` | `src/services/discord/router/queue_status_presentation.rs` | 92 | 6 | 86 |  |
...
| `services::discord::turn_bridge::followup_requeue` | `src/services/discord/turn_bridge/followup_requeue.rs` | 206 | 100 | 106 |  |
...
| `services::discord::turn_bridge::streaming_edit_text` | `src/services/discord/turn_bridge/streaming_edit_text.rs` | 697 | 280 | 417 |  |
...
| `services::discord::turn_view_reconciler` | `src/services/discord/turn_view_reconciler.rs` | 2212 | 2212 | 0 | giant-file |
