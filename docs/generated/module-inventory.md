...
| `cli::client` | `src/cli/client.rs` | 1419 | giant-file |
...
| `db::auto_queue` | `src/db/auto_queue.rs` | 1657 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 2633 | giant-file |
...
| `integration_tests::tests::high_risk_recovery` | `src/integration_tests/tests/high_risk_recovery.rs` | 1069 | giant-file |
| `kanban` | `src/kanban.rs` | 2025 | giant-file |
...
| `server::routes::dispatched_sessions` | `src/server/routes/dispatched_sessions.rs` | 2935 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 1974 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 1917 | giant-file |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 280 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 1814 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 3187 | giant-file |
...
| `services::discord::tmux_lifecycle` | `src/services/discord/tmux_lifecycle.rs` | 425 |  |
...
| `services::memory::memento` | `src/services/memory/memento.rs` | 1744 | giant-file |
...
| `services::platform::shell` | `src/services/platform/shell.rs` | 980 |  |
...
| `services::session_backend` | `src/services/session_backend.rs` | 880 |  |
