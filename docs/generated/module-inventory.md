...
| `server` | `src/server/mod.rs` | 3256 | giant-file |
...
| `server::multinode_regression` | `src/server/multinode_regression.rs` | 268 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 4374 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 254 |  |
