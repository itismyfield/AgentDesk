...
| `db::auto_queue` | `src/db/auto_queue.rs` | 6576 | giant-file |
...
| `dispatch::dispatch_context` | `src/dispatch/dispatch_context.rs` | 4034 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5358 | giant-file |
...
| `services::analytics::dispatch_metrics` | `src/services/analytics/dispatch_metrics.rs` | 253 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5521 | giant-file |
