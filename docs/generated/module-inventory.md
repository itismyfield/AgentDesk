...
| `cli::client` | `src/cli/client.rs` | 1578 | giant-file |
...
| `db::session_observability` | `src/db/session_observability.rs` | 433 |  |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 2297 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 3749 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5505 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3051 | giant-file |
...
| `services::discord::placeholder_controller` | `src/services/discord/placeholder_controller.rs` | 988 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4673 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7072 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 11812 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 3498 | giant-file |
...
| `services::observability::session_inventory` | `src/services/observability/session_inventory.rs` | 264 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2078 | giant-file |
