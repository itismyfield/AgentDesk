...
| `cli::args` | `src/cli/args.rs` | 543 |  |
| `cli::client` | `src/cli/client.rs` | 1405 | giant-file |
| `cli::dcserver` | `src/cli/dcserver.rs` | 1426 | giant-file |
| `cli::direct` | `src/cli/direct.rs` | 1401 | giant-file |
...
| `db::auto_queue` | `src/db/auto_queue.rs` | 1792 | giant-file |
...
| `db::turns` | `src/db/turns.rs` | 375 |  |
| `dispatch` | `src/dispatch/mod.rs` | 4100 | giant-file |
...
| `integration_tests::tests::high_risk_recovery` | `src/integration_tests/tests/high_risk_recovery.rs` | 1073 | giant-file |
| `kanban` | `src/kanban.rs` | 2034 | giant-file |
...
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 2900 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 154 |  |
| `server::routes::domains::reviews` | `src/server/routes/domains/reviews.rs` | 30 |  |
| `server::routes::escalation` | `src/server/routes/escalation.rs` | 1197 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 3512 | giant-file |
...
| `services::discord::commands::model_ui` | `src/services/discord/commands/model_ui.rs` | 463 |  |
...
| `services::discord::commands::skill` | `src/services/discord/commands/skill.rs` | 351 |  |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 1394 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 292 |  |
...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder.rs` | 988 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 978 |  |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 3556 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 1146 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 3734 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 1916 | giant-file |
...
| `services::discord::turn_bridge::memory_lifecycle` | `src/services/discord/turn_bridge/memory_lifecycle.rs` | 181 |  |
| `services::discord::turn_bridge::recall_feedback` | `src/services/discord/turn_bridge/recall_feedback.rs` | 616 |  |
