...
| `services::discord::settings` | `src/services/discord/settings.rs` | 349 | 349 | 0 |  |
...
| `services::discord::settings::validation` | `src/services/discord/settings/validation.rs` | 683 | 308 | 375 |  |
