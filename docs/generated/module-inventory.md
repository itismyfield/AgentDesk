...
| `services::discord::outbound::decision` | `src/services/discord/outbound/decision.rs` | 394 |  |
| `services::discord::outbound::legacy` | `src/services/discord/outbound/legacy.rs` | 687 |  |
| `services::discord::outbound::message` | `src/services/discord/outbound/message.rs` | 419 |  |
