...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder/mod.rs` | 630 | 630 | 0 |  |
...
| `services::discord::settings::content` | `src/services/discord/settings/content.rs` | 529 | 496 | 33 |  |
