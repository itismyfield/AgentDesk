...
| `cli::init` | `src/cli/init.rs` | 1414 | giant-file |
...
| `cli::migrate::postgres_cutover` | `src/cli/migrate/postgres_cutover.rs` | 3084 | giant-file |
| `cli::migrate::source` | `src/cli/migrate/source.rs` | 1612 | giant-file |
| `cli::run` | `src/cli/run.rs` | 389 |  |
| `cli::utils` | `src/cli/utils.rs` | 271 |  |
| `config` | `src/config.rs` | 1716 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 3092 | giant-file |
...
| `engine::transition` | `src/engine/transition.rs` | 1464 | giant-file |
| `error` | `src/error.rs` | 188 |  |
| `github` | `src/github/mod.rs` | 807 |  |
...
| `kanban` | `src/kanban.rs` | 2974 | giant-file |
...
| `runtime_layout` | `src/runtime_layout/mod.rs` | 1369 | giant-file |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1518 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 10579 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 2100 | giant-file |
...
| `server::routes::offices` | `src/server/routes/offices.rs` | 459 |  |
| `server::routes::onboarding` | `src/server/routes/onboarding.rs` | 4464 | giant-file |
| `server::routes::pipeline` | `src/server/routes/pipeline.rs` | 952 |  |
...
| `server::routes::termination_events` | `src/server/routes/termination_events.rs` | 396 |  |
| `server::tick` | `src/server/tick.rs` | 230 |  |
| `server::worker_registry` | `src/server/worker_registry.rs` | 563 |  |
| `server::ws` | `src/server/ws.rs` | 141 |  |
| `services` | `src/services/mod.rs` | 38 |  |
| `services::agent_protocol` | `src/services/agent_protocol.rs` | 172 |  |
| `services::api_friction` | `src/services/api_friction.rs` | 1322 | giant-file |
| `services::auto_queue` | `src/services/auto_queue.rs` | 1120 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 2202 | giant-file |
...
| `services::discord::meeting_orchestrator` | `src/services/discord/meeting_orchestrator.rs` | 3443 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 1989 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 4663 | giant-file |
| `services::discord::router::thread_binding` | `src/services/discord/router/thread_binding.rs` | 129 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 1759 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2489 | giant-file |
| `services::discord::settings::content` | `src/services/discord/settings/content.rs` | 281 |  |
| `services::discord::settings::memory` | `src/services/discord/settings/memory.rs` | 236 |  |
| `services::discord::settings::read` | `src/services/discord/settings/read.rs` | 350 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 3144 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2105 | giant-file |
...
| `services::discord::turn_bridge::memory_postprocess` | `src/services/discord/turn_bridge/memory_postprocess.rs` | 82 |  |
| `services::discord::turn_bridge::recall_feedback` | `src/services/discord/turn_bridge/recall_feedback.rs` | 698 |  |
| `services::discord::turn_bridge::recovery_text` | `src/services/discord/turn_bridge/recovery_text.rs` | 208 |  |
...
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 139 |  |
...
| `services::memory` | `src/services/memory/mod.rs` | 359 |  |
| `services::memory::auto_remember` | `src/services/memory/auto_remember.rs` | 698 |  |
| `services::memory::auto_remember_store` | `src/services/memory/auto_remember_store.rs` | 242 |  |
| `services::memory::local` | `src/services/memory/local.rs` | 115 |  |
| `services::memory::mem0` | `src/services/memory/mem0.rs` | 1019 | giant-file |
| `services::memory::memento` | `src/services/memory/memento.rs` | 2145 | giant-file |
...
| `services::settings` | `src/services/settings.rs` | 316 |  |
| `services::termination_audit` | `src/services/termination_audit.rs` | 401 |  |
