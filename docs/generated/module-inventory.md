...
| `server::routes::dispatched_sessions` | `src/server/routes/dispatched_sessions.rs` | 3109 | giant-file |
...
| `services::discord::tmux_lifecycle` | `src/services/discord/tmux_lifecycle.rs` | 478 |  |
