...
| `services` | `src/services/mod.rs` | 143 | 143 | 0 |  |
...
| `services::claude` | `src/services/claude.rs` | 4400 | 2969 | 1431 | giant-file |
...
| `services::discord::commands::voice::alert` | `src/services/discord/commands/voice/alert.rs` | 48 | 48 | 0 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 880 | 727 | 153 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 5791 | 2557 | 3234 | giant-file |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1289 | 973 | 316 |  |
...
| `services::discord::mailbox_finish` | `src/services/discord/mailbox_finish.rs` | 133 | 133 | 0 |  |
...
| `services::discord::queue_marker` | `src/services/discord/queue_marker.rs` | 638 | 210 | 428 |  |
...
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 1352 | 868 | 484 |  |
...
| `services::discord::router::intake_dispatch` | `src/services/discord/router/intake_dispatch.rs` | 262 | 262 | 0 |  |
| `services::discord::router::intake_dispatch::notice` | `src/services/discord/router/intake_dispatch/notice.rs` | 90 | 74 | 16 |  |
| `services::discord::router::intake_dispatch::queued` | `src/services/discord/router/intake_dispatch/queued.rs` | 99 | 99 | 0 |  |
| `services::discord::router::intake_dispatch::skill` | `src/services/discord/router/intake_dispatch/skill.rs` | 45 | 45 | 0 |  |
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1653 | 1584 | 69 | giant-file |
...
| `services::discord::router::intake_gate::queue_effects` | `src/services/discord/router/intake_gate/queue_effects.rs` | 1271 | 836 | 435 |  |
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 632 | 283 | 349 |  |
| `services::discord::router::intake_queue_transaction` | `src/services/discord/router/intake_queue_transaction.rs` | 980 | 504 | 476 |  |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 206 | 206 | 0 |  |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1693 | 1370 | 323 | giant-file |
...
| `services::discord::turn_bridge::streaming_edit_text` | `src/services/discord/turn_bridge/streaming_edit_text.rs` | 698 | 281 | 417 |  |
...
| `services::discord::turn_bridge::terminal_outcome_delivery` | `src/services/discord/turn_bridge/terminal_outcome_delivery.rs` | 878 | 878 | 0 |  |
...
| `services::discord::turn_view_reconciler` | `src/services/discord/turn_view_reconciler.rs` | 2214 | 2214 | 0 | giant-file |
...
| `services::routines` | `src/services/routines/mod.rs` | 48 | 38 | 10 |  |
| `services::routines::action` | `src/services/routines/action.rs` | 365 | 237 | 128 |  |
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 2509 | 2026 | 483 | giant-file |
...
| `services::routines::runtime` | `src/services/routines/runtime.rs` | 1047 | 871 | 176 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 7178 | 3262 | 3916 | giant-file |
