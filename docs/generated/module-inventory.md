...
| `cli::dcserver` | `src/cli/dcserver.rs` | 1635 | 1635 | 0 | giant-file |
| `cli::direct` | `src/cli/direct.rs` | 1801 | 1801 | 0 | giant-file |
...
| `config` | `src/config.rs` | 2844 | 2559 | 285 | giant-file |
...
| `db::dispatched_sessions` | `src/db/dispatched_sessions.rs` | 2109 | 1612 | 497 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 2481 | 1167 | 1314 | giant-file |
...
| `dispatch` | `src/dispatch/mod.rs` | 56 | 56 | 0 |  |
...
| `dispatch::dispatch_create` | `src/dispatch/dispatch_create.rs` | 1515 | 1385 | 130 | giant-file |
| `dispatch::dispatch_query` | `src/dispatch/dispatch_query.rs` | 89 | 89 | 0 |  |
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1695 | 1508 | 187 | giant-file |
...
| `server` | `src/server/mod.rs` | 3050 | 2640 | 410 | giant-file |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1182 | 1182 | 0 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6396 | 5956 | 440 | giant-file |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2347 | 1992 | 355 | giant-file |
...
| `server::routes::meetings` | `src/server/routes/meetings.rs` | 1266 | 1266 | 0 | giant-file |
| `server::routes::memory_api` | `src/server/routes/memory_api.rs` | 537 | 492 | 45 |  |
...
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 546 | 546 | 0 |  |
...
| `services::cluster::node_registry` | `src/services/cluster/node_registry.rs` | 1268 | 998 | 270 |  |
...
| `services::cluster::session_discovery` | `src/services/cluster/session_discovery.rs` | 1279 | 692 | 587 |  |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4649 | 1772 | 2877 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 530 | 197 | 333 |  |
| `services::discord` | `src/services/discord/mod.rs` | 4924 | 4107 | 817 | giant-file |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 1170 | 922 | 248 |  |
| `services::discord::commands` | `src/services/discord/commands/mod.rs` | 115 | 115 | 0 |  |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1021 | 953 | 68 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 416 | 416 | 0 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3925 | 2730 | 1195 | giant-file |
...
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 238 | 112 | 126 |  |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 915 | 858 | 57 |  |
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 1526 | 652 | 874 |  |
...
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 1994 | 994 | 1000 |  |
...
| `services::discord::idle_recap_interaction` | `src/services/discord/idle_recap_interaction.rs` | 193 | 193 | 0 |  |
| `services::discord::idle_relay_drift` | `src/services/discord/idle_relay_drift.rs` | 764 | 529 | 235 |  |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 7382 | 3137 | 4245 | giant-file |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 904 | 721 | 183 |  |
...
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 1802 | 824 | 978 |  |
...
| `services::discord::outbound::send_api` | `src/services/discord/outbound/send_api.rs` | 474 | 288 | 186 |  |
| `services::discord::outbound::send_gate` | `src/services/discord/outbound/send_gate.rs` | 537 | 373 | 164 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 642 | 642 | 0 |  |
...
| `services::discord::placeholder_live_events::status_panel` | `src/services/discord/placeholder_live_events/status_panel.rs` | 700 | 700 | 0 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4153 | 3438 | 715 | giant-file |
...
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 647 | 510 | 137 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 1862 | 1007 | 855 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 3490 | 2986 | 504 | giant-file |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3663 | 3615 | 48 | giant-file |
...
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 335 | 321 | 14 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4184 | 1738 | 2446 | giant-file |
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 2201 | 1712 | 489 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2723 | 2048 | 675 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10230 | 7065 | 3165 | giant-file |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 7732 | 4289 | 3443 | giant-file |
...
| `services::discord::tui_prompt_relay::idle_transcript_scan` | `src/services/discord/tui_prompt_relay/idle_transcript_scan.rs` | 421 | 296 | 125 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6657 | 6234 | 423 | giant-file |
...
| `services::discord::turn_bridge::chunk_compose` | `src/services/discord/turn_bridge/chunk_compose.rs` | 60 | 60 | 0 |  |
...
| `services::discord::turn_bridge::recovery_text` | `src/services/discord/turn_bridge/recovery_text.rs` | 627 | 523 | 104 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1714 | 638 | 1076 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 4577 | 2823 | 1754 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 1454 | 1375 | 79 | giant-file |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1160 | 1120 | 40 | giant-file |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 3611 | 1625 | 1986 | giant-file |
