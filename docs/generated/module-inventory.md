...
| `config` | `src/config.rs` | 2631 | giant-file |
...
| `services::discord::commands::inspect` | `src/services/discord/commands/inspect.rs` | 1058 | giant-file |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events.rs` | 2038 | giant-file |
