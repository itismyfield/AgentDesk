...
| `kanban::hooks` | `src/kanban/hooks.rs` | 781 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 496 |  |
...
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 1107 | giant-file |
