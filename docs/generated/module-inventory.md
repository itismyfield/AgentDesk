...
| `config` | `src/config.rs` | 2313 | giant-file |
...
| `server` | `src/server/mod.rs` | 3252 | giant-file |
...
| `server::routes::cluster` | `src/server/routes/cluster.rs` | 207 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 4148 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 225 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 669 |  |
...
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 679 |  |
| `services::discord` | `src/services/discord/mod.rs` | 5856 | giant-file |
...
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 904 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5760 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7204 | giant-file |
| `services::discord::router::thread_binding` | `src/services/discord/router/thread_binding.rs` | 129 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 2844 | giant-file |
