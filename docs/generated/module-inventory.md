...
| `cli::args` | `src/cli/args.rs` | 1593 | 976 | 617 |  |
...
| `config` | `src/config.rs` | 3183 | 2764 | 419 | giant-file |
...
| `db::intake_outbox` | `src/db/intake_outbox.rs` | 2247 | 694 | 1553 |  |
...
| `db::scheduled_messages` | `src/db/scheduled_messages.rs` | 978 | 978 | 0 |  |
...
| `db::scheduled_messages::writes` | `src/db/scheduled_messages/writes.rs` | 61 | 61 | 0 |  |
...
| `db::session_transcripts` | `src/db/session_transcripts.rs` | 697 | 588 | 109 |  |
...
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1641 | 1448 | 193 | giant-file |
...
| `server::routes::scheduled_messages` | `src/server/routes/scheduled_messages.rs` | 1053 | 983 | 70 |  |
...
| `services` | `src/services/mod.rs` | 150 | 150 | 0 |  |
...
| `services::auto_queue::planning` | `src/services/auto_queue/planning.rs` | 484 | 283 | 201 |  |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 4028 | 2226 | 1802 | giant-file |
...
| `services::claude_tui::transcript_tail` | `src/services/claude_tui/transcript_tail.rs` | 652 | 329 | 323 |  |
...
| `services::cluster::intake_router_hook` | `src/services/cluster/intake_router_hook.rs` | 2723 | 973 | 1750 |  |
...
| `services::cluster::intake_worker` | `src/services/cluster/intake_worker.rs` | 694 | 508 | 186 |  |
| `services::cluster::intake_worker_capabilities` | `src/services/cluster/intake_worker_capabilities.rs` | 233 | 178 | 55 |  |
| `services::cluster::node_registry` | `src/services/cluster/node_registry.rs` | 1024 | 754 | 270 |  |
...
| `services::cluster::stream_relay` | `src/services/cluster/stream_relay.rs` | 1640 | 987 | 653 |  |
...
| `services::codex` | `src/services/codex.rs` | 3838 | 3118 | 720 | giant-file |
| `services::codex_remote_policy` | `src/services/codex_remote_policy.rs` | 49 | 32 | 17 |  |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 2556 | 1405 | 1151 | giant-file |
| `services::codex_tui` | `src/services/codex_tui/mod.rs` | 5 | 5 | 0 |  |
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 3100 | 1788 | 1312 | giant-file |
| `services::codex_tui::rollout_index` | `src/services/codex_tui/rollout_index.rs` | 1200 | 618 | 582 |  |
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4259 | 1334 | 2925 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5636 | 4166 | 1470 | giant-file |
| `services::discord::abandon_request_store` | `src/services/discord/abandon_request_store.rs` | 477 | 355 | 122 |  |
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 1020 | 905 | 115 |  |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 3217 | 1809 | 1408 | giant-file |
...
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 953 | 886 | 67 |  |
...
| `services::discord::formatting::long_send_rollback` | `src/services/discord/formatting/long_send_rollback.rs` | 482 | 482 | 0 |  |
...
| `services::discord::health::liveness_authority` | `src/services/discord/health/liveness_authority.rs` | 1043 | 559 | 484 |  |
...
| `services::discord::health::relay_auto_heal` | `src/services/discord/health/relay_auto_heal.rs` | 2148 | 718 | 1430 |  |
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 278 | 101 | 177 |  |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 1279 | 999 | 280 |  |
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 2417 | 979 | 1438 |  |
| `services::discord::health::stall_liveness::redrive_grace` | `src/services/discord/health/stall_liveness/redrive_grace.rs` | 652 | 258 | 394 |  |
| `services::discord::health::stall_verdict` | `src/services/discord/health/stall_verdict.rs` | 1352 | 425 | 927 |  |
| `services::discord::health::watcher_respawn` | `src/services/discord/health/watcher_respawn.rs` | 1404 | 632 | 772 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5858 | 615 | 5243 |  |
...
| `services::discord::inflight::clear_store` | `src/services/discord/inflight/clear_store/mod.rs` | 880 | 880 | 0 |  |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1350 | 997 | 353 |  |
...
| `services::discord::inflight::save_store` | `src/services/discord/inflight/save_store.rs` | 979 | 245 | 734 |  |
| `services::discord::inflight::save_store::delivery_rewind` | `src/services/discord/inflight/save_store/delivery_rewind.rs` | 59 | 59 | 0 |  |
| `services::discord::inflight::save_store::identity_gate` | `src/services/discord/inflight/save_store/identity_gate.rs` | 1415 | 956 | 459 |  |
...
| `services::discord::inflight::store` | `src/services/discord/inflight/store.rs` | 405 | 351 | 54 |  |
...
| `services::discord::mailbox_finish` | `src/services/discord/mailbox_finish.rs` | 206 | 195 | 11 |  |
...
| `services::discord::meeting_orchestrator` | `src/services/discord/meeting_orchestrator.rs` | 3223 | 3223 | 0 | giant-file |
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 54 | 54 | 0 |  |
...
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 3078 | 1370 | 1708 | giant-file |
| `services::discord::outbound::manual_delivery` | `src/services/discord/outbound/manual_delivery.rs` | 1293 | 663 | 630 |  |
...
| `services::discord::outbound::send_gate` | `src/services/discord/outbound/send_gate.rs` | 565 | 359 | 206 |  |
...
| `services::discord::prompt_builder::memory_guidance` | `src/services/discord/prompt_builder/memory_guidance.rs` | 328 | 138 | 190 |  |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 2327 | 768 | 1559 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 521 | 465 | 56 |  |
...
| `services::discord::recovery_engine::manual_rebind` | `src/services/discord/recovery_engine/manual_rebind/mod.rs` | 1427 | 1001 | 426 | giant-file |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 2167 | 982 | 1185 |  |
...
| `services::discord::recovery_engine::restore_inflight` | `src/services/discord/recovery_engine/restore_inflight.rs` | 2397 | 2328 | 69 | giant-file |
...
| `services::discord::recovery_engine::terminal_text_idempotency` | `src/services/discord/recovery_engine/terminal_text_idempotency.rs` | 942 | 466 | 476 |  |
...
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 653 | 280 | 373 |  |
...
| `services::discord::relay_health` | `src/services/discord/relay_health.rs` | 311 | 190 | 121 |  |
| `services::discord::relay_health::frontier` | `src/services/discord/relay_health/frontier.rs` | 155 | 112 | 43 |  |
| `services::discord::relay_owner_observability` | `src/services/discord/relay_owner_observability.rs` | 459 | 344 | 115 |  |
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 3535 | 1538 | 1997 | giant-file |
| `services::discord::relay_recovery::tests::circuit_breaker_apply` | `src/services/discord/relay_recovery/tests/circuit_breaker_apply.rs` | 316 | 0 | 316 |  |
| `services::discord::relay_recovery_auto_heal_apply` | `src/services/discord/relay_recovery_auto_heal_apply.rs` | 714 | 295 | 419 |  |
...
| `services::discord::relay_recovery_circuit_alert_producer` | `src/services/discord/relay_recovery_circuit_alert_producer.rs` | 290 | 170 | 120 |  |
| `services::discord::relay_recovery_circuit_breaker` | `src/services/discord/relay_recovery_circuit_breaker.rs` | 1684 | 719 | 965 |  |
...
| `services::discord::router::intake_dispatch` | `src/services/discord/router/intake_dispatch.rs` | 265 | 265 | 0 |  |
| `services::discord::router::intake_dispatch::notice` | `src/services/discord/router/intake_dispatch/notice.rs` | 93 | 77 | 16 |  |
| `services::discord::router::intake_dispatch::queued` | `src/services/discord/router/intake_dispatch/queued.rs` | 101 | 101 | 0 |  |
...
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 641 | 283 | 358 |  |
| `services::discord::router::intake_queue_transaction` | `src/services/discord/router/intake_queue_transaction.rs` | 1170 | 550 | 620 |  |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 210 | 210 | 0 |  |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1851 | 1444 | 407 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3138 | 2715 | 423 | giant-file |
...
| `services::discord::router::message_handler::intake_turn::inflight_create_log` | `src/services/discord/router/message_handler/intake_turn/inflight_create_log.rs` | 31 | 31 | 0 |  |
...
| `services::discord::router::message_handler::intake_turn::steering_hook` | `src/services/discord/router/message_handler/intake_turn/steering_hook.rs` | 276 | 178 | 98 |  |
...
| `services::discord::router::message_handler::provider_isolation` | `src/services/discord/router/message_handler/provider_isolation.rs` | 763 | 604 | 159 |  |
...
| `services::discord::router::message_handler::watchdog` | `src/services/discord/router/message_handler/watchdog.rs` | 1266 | 971 | 295 |  |
...
| `services::discord::runtime_bootstrap::gateway_runtime` | `src/services/discord/runtime_bootstrap/gateway_runtime.rs` | 143 | 143 | 0 |  |
...
| `services::discord::runtime_bootstrap::recovery_flush` | `src/services/discord/runtime_bootstrap/recovery_flush.rs` | 416 | 416 | 0 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 262 | 262 | 0 |  |
| `services::discord::runtime_bootstrap::shutdown` | `src/services/discord/runtime_bootstrap/shutdown.rs` | 209 | 209 | 0 |  |
| `services::discord::runtime_bootstrap::spawns` | `src/services/discord/runtime_bootstrap/spawns.rs` | 360 | 289 | 71 |  |
...
| `services::discord::session_relay_sink::task_notification_context` | `src/services/discord/session_relay_sink/task_notification_context.rs` | 809 | 509 | 300 |  |
...
| `services::discord::shared_state` | `src/services/discord/shared_state.rs` | 754 | 683 | 71 |  |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1960 | 1012 | 948 | giant-file |
...
| `services::discord::task_notification_delivery` | `src/services/discord/task_notification_delivery/mod.rs` | 938 | 938 | 0 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2561 | 1628 | 933 | giant-file |
...
| `services::discord::tmux_overload_retry` | `src/services/discord/tmux_overload_retry.rs` | 348 | 201 | 147 |  |
...
| `services::discord::tmux_session_files` | `src/services/discord/tmux_session_files.rs` | 579 | 547 | 32 |  |
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3558 | 3558 | 0 | giant-file |
| `services::discord::tmux_watcher::commit_decisions` | `src/services/discord/tmux_watcher/commit_decisions.rs` | 297 | 175 | 122 |  |
...
| `services::discord::tmux_watcher::placeholder_reclaim` | `src/services/discord/tmux_watcher/placeholder_reclaim.rs` | 322 | 135 | 187 |  |
...
| `services::discord::tmux_watcher::supervisor_relay` | `src/services/discord/tmux_watcher/supervisor_relay.rs` | 621 | 621 | 0 |  |
...
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 3816 | 1496 | 2320 | giant-file |
...
| `services::discord::tui_prompt_relay::bridge_completion` | `src/services/discord/tui_prompt_relay/bridge_completion.rs` | 168 | 82 | 86 |  |
...
| `services::discord::tui_prompt_relay::codex_idle_rollout` | `src/services/discord/tui_prompt_relay/codex_idle_rollout.rs` | 619 | 619 | 0 |  |
...
| `services::discord::tui_prompt_relay::synthetic_start` | `src/services/discord/tui_prompt_relay/synthetic_start.rs` | 2462 | 1120 | 1342 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 998 | 998 | 0 |  |
...
| `services::discord::turn_bridge::runtime_handoff_loop::guarded_save` | `src/services/discord/turn_bridge/runtime_handoff_loop/guarded_save.rs` | 216 | 81 | 135 |  |
...
| `services::discord::turn_bridge::status_panel` | `src/services/discord/turn_bridge/status_panel.rs` | 683 | 683 | 0 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 2010 | 745 | 1265 |  |
...
| `services::discord::turn_bridge::two_message_panel` | `src/services/discord/turn_bridge/two_message_panel.rs` | 802 | 271 | 531 |  |
...
| `services::discord::turn_completion_events` | `src/services/discord/turn_completion_events.rs` | 101 | 101 | 0 |  |
...
| `services::discord::turn_view_reconciler` | `src/services/discord/turn_view_reconciler.rs` | 2360 | 2360 | 0 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 3272 | 994 | 2278 |  |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 2219 | 1767 | 452 | giant-file |
...
| `services::dispatches::outbox_claiming` | `src/services/dispatches/outbox_claiming.rs` | 933 | 516 | 417 |  |
...
| `services::maintenance::jobs::worktree_orphan_sweep` | `src/services/maintenance/jobs/worktree_orphan_sweep.rs` | 1978 | 976 | 1002 |  |
...
| `services::observability::metrics` | `src/services/observability/metrics.rs` | 362 | 362 | 0 |  |
...
| `services::observability::turn_lifecycle` | `src/services/observability/turn_lifecycle.rs` | 951 | 486 | 465 |  |
...
| `services::onboarding` | `src/services/onboarding/mod.rs` | 2934 | 2884 | 50 | giant-file |
...
| `services::opencode` | `src/services/opencode.rs` | 3129 | 2764 | 365 | giant-file |
...
| `services::provider` | `src/services/provider.rs` | 2677 | 1903 | 774 | giant-file |
...
| `services::qwen` | `src/services/qwen.rs` | 2216 | 2195 | 21 | giant-file |
...
| `services::routines::discord_log` | `src/services/routines/discord_log.rs` | 2054 | 1596 | 458 | giant-file |
...
| `services::routines::store` | `src/services/routines/store.rs` | 4273 | 3560 | 713 | giant-file |
| `services::scheduled_messages` | `src/services/scheduled_messages.rs` | 1291 | 979 | 312 |  |
| `services::scheduled_messages::context_snapshot` | `src/services/scheduled_messages/context_snapshot.rs` | 862 | 427 | 435 |  |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 4778 | 2153 | 2625 | giant-file |
| `services::tui_prompt_dedupe::synthetic_prompt` | `src/services/tui_prompt_dedupe/synthetic_prompt.rs` | 34 | 34 | 0 |  |
| `services::tui_steering` | `src/services/tui_steering.rs` | 246 | 130 | 116 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 7189 | 3233 | 3956 | giant-file |
...
| `services::turn_orchestrator::episode_identity` | `src/services/turn_orchestrator/episode_identity.rs` | 273 | 120 | 153 |  |
...
| `services::turn_orchestrator::queue_cancellation` | `src/services/turn_orchestrator/queue_cancellation.rs` | 137 | 85 | 52 |  |
