...
| `config` | `src/config.rs` | 3102 | giant-file |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1075 | giant-file |
...
| `services::cluster` | `src/services/cluster/mod.rs` | 18 |  |
...
| `services::cluster::watcher_supervisor` | `src/services/cluster/watcher_supervisor.rs` | 510 |  |
| `services::codex` | `src/services/codex.rs` | 3161 | giant-file |
...
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 929 |  |
...
| `services::routines::store` | `src/services/routines/store.rs` | 3097 | giant-file |
