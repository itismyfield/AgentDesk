...
| `config` | `src/config.rs` | 1749 | giant-file |
...
| `engine::loader` | `src/engine/loader.rs` | 438 |  |
...
| `server` | `src/server/mod.rs` | 3002 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 210 |  |
...
| `server::routes::onboarding` | `src/server/routes/onboarding.rs` | 4469 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1109 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 945 |  |
| `services::discord::internal_api` | `src/services/discord/internal_api.rs` | 470 |  |
| `services::discord::mcp_credential_watcher` | `src/services/discord/mcp_credential_watcher.rs` | 645 |  |
| `services::discord::meeting_orchestrator` | `src/services/discord/meeting_orchestrator.rs` | 3435 | giant-file |
...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder.rs` | 1644 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2392 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2569 | giant-file |
...
| `services::observability` | `src/services/observability.rs` | 3254 | giant-file |
