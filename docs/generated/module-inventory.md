...
| `services::claude_compact_trigger` | `src/services/claude_compact_trigger.rs` | 1048 | 506 | 542 |  |
...
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 342 | 318 | 24 |  |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 855 | 855 | 0 |  |
...
| `services::discord::tui_prompt_relay::claude_idle_tail` | `src/services/discord/tui_prompt_relay/claude_idle_tail.rs` | 550 | 550 | 0 |  |
...
| `services::discord::turn_bridge::stream_loop` | `src/services/discord/turn_bridge/stream_loop.rs` | 978 | 978 | 0 |  |
...
| `services::discord::turn_bridge::stream_loop::content_arms::active_usage` | `src/services/discord/turn_bridge/stream_loop/content_arms/active_usage.rs` | 148 | 55 | 93 |  |
...
| `services::session_backend::stream_line` | `src/services/session_backend/stream_line.rs` | 809 | 594 | 215 |  |
