...
| `db::auto_queue` | `src/db/auto_queue.rs` | 3425 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 3007 | giant-file |
...
| `engine::ops::exec_ops` | `src/engine/ops/exec_ops.rs` | 395 |  |
...
| `server::routes::settings` | `src/server/routes/settings.rs` | 961 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 2104 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2011 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1065 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 3547 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 3016 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2013 | giant-file |
