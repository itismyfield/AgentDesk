...
| `services::claude` | `src/services/claude.rs` | 4304 | 2949 | 1355 | giant-file |
...
| `services::claude_e::process` | `src/services/claude_e/process.rs` | 448 | 390 | 58 |  |
...
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 945 | 878 | 67 |  |
...
| `services::discord::prompt_builder::channel_recent_context` | `src/services/discord/prompt_builder/channel_recent_context.rs` | 437 | 201 | 236 |  |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1746 | 1393 | 353 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3110 | 2687 | 423 | giant-file |
...
| `services::gemini` | `src/services/gemini.rs` | 1392 | 1361 | 31 | giant-file |
...
| `services::provider` | `src/services/provider.rs` | 2617 | 1881 | 736 | giant-file |
...
| `services::provider::cancel_token_cleanup::executor` | `src/services/provider/cancel_token_cleanup/executor.rs` | 489 | 322 | 167 |  |
