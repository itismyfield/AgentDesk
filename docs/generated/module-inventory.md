...
| `integration_tests::discord_flow::scenarios` | `src/integration_tests/discord_flow/scenarios.rs` | 648 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 3132 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 6079 | giant-file |
