...
| `services::discord` | `src/services/discord/mod.rs` | 5308 | 4157 | 1151 | giant-file |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 1366 | 993 | 373 |  |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3848 | 2856 | 992 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1237 | 999 | 238 |  |
| `services::discord::gateway_voice_queue` | `src/services/discord/gateway_voice_queue.rs` | 92 | 17 | 75 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 811 | 658 | 153 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 4725 | 2580 | 2145 | giant-file |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1309 | 1014 | 295 | giant-file |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 1769 | 683 | 1086 |  |
...
| `services::discord::reaction_lifecycle` | `src/services/discord/reaction_lifecycle.rs` | 498 | 456 | 42 |  |
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 3560 | 3010 | 550 | giant-file |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 2820 | 1287 | 1533 | giant-file |
...
| `services::discord::router::intake_gate::stale_turn` | `src/services/discord/router/intake_gate/stale_turn.rs` | 619 | 273 | 346 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 2854 | 2807 | 47 | giant-file |
| `services::discord::router::message_handler::intake_turn::race_loss` | `src/services/discord/router/message_handler/intake_turn/race_loss.rs` | 682 | 594 | 88 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 258 | 258 | 0 |  |
...
| `services::discord::runtime_store` | `src/services/discord/runtime_store.rs` | 392 | 364 | 28 |  |
...
| `services::discord::steering` | `src/services/discord/steering.rs` | 442 | 327 | 115 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7241 | 7241 | 0 | giant-file |
| `services::discord::tmux_watcher::commit_decisions` | `src/services/discord/tmux_watcher/commit_decisions.rs` | 288 | 166 | 122 |  |
...
| `services::discord::tmux_watcher::single_message_footer` | `src/services/discord/tmux_watcher/single_message_footer.rs` | 691 | 577 | 114 |  |
...
| `services::discord::tui_direct_abort_marker` | `src/services/discord/tui_direct_abort_marker/mod.rs` | 2459 | 824 | 1635 |  |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 985 | 985 | 0 |  |
...
| `services::discord::tui_prompt_relay::synthetic_start` | `src/services/discord/tui_prompt_relay/synthetic_start.rs` | 1539 | 1040 | 499 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6587 | 6164 | 423 | giant-file |
...
| `services::discord::turn_bridge::single_message_footer` | `src/services/discord/turn_bridge/single_message_footer.rs` | 971 | 657 | 314 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1798 | 676 | 1122 |  |
...
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 4772 | 1048 | 3724 | giant-file |
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 1529 | 566 | 963 |  |
...
| `services::discord::turn_finalizer::finalize` | `src/services/discord/turn_finalizer/finalize.rs` | 569 | 241 | 328 |  |
| `services::discord::turn_finalizer::finalize_context` | `src/services/discord/turn_finalizer/finalize_context.rs` | 117 | 117 | 0 |  |
...
| `services::discord::turn_view_reconciler` | `src/services/discord/turn_view_reconciler.rs` | 1337 | 1337 | 0 | giant-file |
