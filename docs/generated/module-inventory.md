...
| `server::dto::dispatches` | `src/server/dto/dispatches.rs` | 158 |  |
...
| `services::analytics` | `src/services/analytics.rs` | 882 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5556 | giant-file |
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 1433 | giant-file |
| `services::discord::health::session_enrichment` | `src/services/discord/health/session_enrichment.rs` | 210 |  |
