...
| `cli::args` | `src/cli/args.rs` | 883 |  |
| `cli::client` | `src/cli/client.rs` | 1583 | giant-file |
| `cli::dcserver` | `src/cli/dcserver.rs` | 1496 | giant-file |
| `cli::direct` | `src/cli/direct.rs` | 1535 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 1435 | giant-file |
...
| `kanban` | `src/kanban.rs` | 3875 | giant-file |
...
| `server` | `src/server/mod.rs` | 3234 | giant-file |
| `server::cron_catalog` | `src/server/cron_catalog.rs` | 92 |  |
| `server::maintenance` | `src/server/maintenance.rs` | 916 |  |
| `server::routes` | `src/server/routes/mod.rs` | 282 |  |
| `server::routes::agents` | `src/server/routes/agents.rs` | 2301 | giant-file |
...
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 5402 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 3755 | giant-file |
...
| `server::routes::domains::agents` | `src/server/routes/domains/agents.rs` | 52 |  |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 260 |  |
...
| `server::routes::onboarding` | `src/server/routes/onboarding.rs` | 5271 | giant-file |
| `server::routes::pipeline` | `src/server/routes/pipeline.rs` | 1392 | giant-file |
| `server::routes::provider_cli_api` | `src/server/routes/provider_cli_api.rs` | 847 |  |
| `server::routes::queue_api` | `src/server/routes/queue_api.rs` | 403 |  |
...
| `services` | `src/services/mod.rs` | 52 |  |
...
| `services::auto_queue` | `src/services/auto_queue.rs` | 1047 | giant-file |
| `services::auto_queue::activate_bridge` | `src/services/auto_queue/activate_bridge.rs` | 23 |  |
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 995 |  |
| `services::auto_queue::activate_preflight` | `src/services/auto_queue/activate_preflight.rs` | 198 |  |
| `services::auto_queue::activate_route` | `src/services/auto_queue/activate_route.rs` | 17 |  |
| `services::auto_queue::cancel_run` | `src/services/auto_queue/cancel_run.rs` | 987 |  |
| `services::auto_queue::command` | `src/services/auto_queue/command.rs` | 760 |  |
| `services::auto_queue::control_routes` | `src/services/auto_queue/control_routes.rs` | 352 |  |
| `services::auto_queue::dispatch_command` | `src/services/auto_queue/dispatch_command.rs` | 915 |  |
| `services::auto_queue::dispatch_query` | `src/services/auto_queue/dispatch_query.rs` | 232 |  |
| `services::auto_queue::fsm` | `src/services/auto_queue/fsm.rs` | 842 |  |
| `services::auto_queue::order_routes` | `src/services/auto_queue/order_routes.rs` | 581 |  |
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 302 |  |
| `services::auto_queue::planning` | `src/services/auto_queue/planning.rs` | 494 |  |
| `services::auto_queue::query` | `src/services/auto_queue/query.rs` | 295 |  |
| `services::auto_queue::route` | `src/services/auto_queue/route.rs` | 34 |  |
| `services::auto_queue::route_dispatch` | `src/services/auto_queue/route_dispatch.rs` | 275 |  |
| `services::auto_queue::route_generate` | `src/services/auto_queue/route_generate.rs` | 429 |  |
| `services::auto_queue::route_types` | `src/services/auto_queue/route_types.rs` | 166 |  |
| `services::auto_queue::runtime` | `src/services/auto_queue/runtime.rs` | 329 |  |
| `services::auto_queue::slot_routes` | `src/services/auto_queue/slot_routes.rs` | 267 |  |
| `services::auto_queue::view` | `src/services/auto_queue/view.rs` | 299 |  |
| `services::auto_queue::view_routes` | `src/services/auto_queue/view_routes.rs` | 701 |  |
...
| `services::discord::commands::config` | `src/services/discord/commands/config.rs` | 1810 | giant-file |
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 842 |  |
...
| `services::discord::commands::restart` | `src/services/discord/commands/restart.rs` | 346 |  |
| `services::discord::commands::session` | `src/services/discord/commands/session.rs` | 370 |  |
| `services::discord::commands::skill` | `src/services/discord/commands/skill.rs` | 397 |  |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3105 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 826 |  |
| `services::discord::handoff` | `src/services/discord/handoff.rs` | 260 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 4527 | giant-file |
...
| `services::discord::outbound::delivery` | `src/services/discord/outbound/delivery.rs` | 589 |  |
| `services::discord::outbound::legacy` | `src/services/discord/outbound/legacy.rs` | 992 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4682 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1250 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7112 | giant-file |
| `services::discord::router::thread_binding` | `src/services/discord/router/thread_binding.rs` | 129 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 2647 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 1887 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 11954 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 3609 | giant-file |
...
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 783 |  |
...
| `services::git` | `src/services/git/mod.rs` | 80 |  |
...
| `services::git::worktree_resolver` | `src/services/git/worktree_resolver.rs` | 307 |  |
| `services::issue_announcements` | `src/services/issue_announcements.rs` | 409 |  |
...
| `services::observability` | `src/services/observability/mod.rs` | 3393 | giant-file |
...
| `services::platform` | `src/services/platform/mod.rs` | 24 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2242 | giant-file |
| `supervisor` | `src/supervisor/mod.rs` | 817 |  |
| `ui` | `src/ui/mod.rs` | 1 |  |
| `ui::ai_screen` | `src/ui/ai_screen.rs` | 103 |  |
| `utils` | `src/utils/mod.rs` | 3 |  |
