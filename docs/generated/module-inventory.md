...
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 10 |  |
| `db::auto_queue::core` | `src/db/auto_queue/core.rs` | 5875 | giant-file |
...
| `dispatch` | `src/dispatch/mod.rs` | 4540 | giant-file |
...
| `kanban` | `src/kanban/mod.rs` | 15 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 2475 | giant-file |
| `kanban::test_support` | `src/kanban/test_support.rs` | 484 |  |
| `kanban::transition_cleanup` | `src/kanban/transition_cleanup.rs` | 669 |  |
...
| `services::api_friction` | `src/services/api_friction/mod.rs` | 24 |  |
| `services::api_friction::core` | `src/services/api_friction/core.rs` | 540 |  |
| `services::api_friction::markers` | `src/services/api_friction/markers.rs` | 195 |  |
| `services::api_friction::storage` | `src/services/api_friction/storage.rs` | 365 |  |
...
| `services::api_friction::tests::pg_storage` | `src/services/api_friction/tests/pg_storage.rs` | 188 |  |
...
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 354 |  |
...
| `services::dispatches::outbox_claiming` | `src/services/dispatches/outbox_claiming.rs` | 195 |  |
