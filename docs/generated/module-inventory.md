...
| `db::agents` | `src/db/agents.rs` | 1051 | giant-file |
| `db::auto_queue` | `src/db/auto_queue.rs` | 6032 | giant-file |
...
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1611 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 4640 | giant-file |
...
| `server::routes::onboarding` | `src/server/routes/onboarding.rs` | 4520 | giant-file |
...
| `server::routes::review_verdict::decision_route` | `src/server/routes/review_verdict/decision_route.rs` | 1870 | giant-file |
...
| `services` | `src/services/mod.rs` | 49 |  |
...
| `services::discord::response_sanitizer` | `src/services/discord/response_sanitizer.rs` | 167 |  |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7008 | giant-file |
...
| `services::platform::binary_resolver` | `src/services/platform/binary_resolver.rs` | 1166 | giant-file |
...
| `services::provider_cli` | `src/services/provider_cli/mod.rs` | 17 |  |
