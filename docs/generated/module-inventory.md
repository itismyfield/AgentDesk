...
| `config` | `src/config.rs` | 3119 | giant-file |
...
| `engine::loader` | `src/engine/loader.rs` | 1670 | giant-file |
...
| `services::claude` | `src/services/claude.rs` | 3829 | giant-file |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 955 |  |
...
| `services::codex` | `src/services/codex.rs` | 3237 | giant-file |
...
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 1073 | giant-file |
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 2690 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 326 |  |
| `services::discord` | `src/services/discord/mod.rs` | 6498 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 2688 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5591 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 8811 | giant-file |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 472 |  |
| `services::discord::streaming_finalizer` | `src/services/discord/streaming_finalizer.rs` | 252 |  |
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6234 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3911 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6471 | giant-file |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 1749 | giant-file |
