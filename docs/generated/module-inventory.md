...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2346 | 1655 | 691 | giant-file |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1493 | 1256 | 237 | giant-file |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 2807 | 1656 | 1151 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4195 | 1270 | 2925 | giant-file |
| `services::codex_tui::rollout_tail::parser` | `src/services/codex_tui/rollout_tail/parser.rs` | 405 | 405 | 0 |  |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 609 | 256 | 353 |  |
| `services::discord` | `src/services/discord/mod.rs` | 5066 | 4110 | 956 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3753 | 2801 | 952 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1232 | 994 | 238 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3350 | 2133 | 1217 | giant-file |
| `services::discord::health::recovery::leak_recovery_ledger` | `src/services/discord/health/recovery/leak_recovery_ledger.rs` | 336 | 336 | 0 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 7356 | 3016 | 4340 | giant-file |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1006 | 761 | 245 |  |
...
| `services::discord::outbound::manual_delivery` | `src/services/discord/outbound/manual_delivery.rs` | 1178 | 581 | 597 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 656 | 656 | 0 |  |
...
| `services::discord::placeholder_live_events::status_panel` | `src/services/discord/placeholder_live_events/status_panel.rs` | 696 | 696 | 0 |  |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1299 | 1004 | 295 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4184 | 3424 | 760 | giant-file |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 144 | 102 | 42 |  |
...
| `services::discord::router::intake_queue_transaction` | `src/services/discord/router/intake_queue_transaction.rs` | 823 | 467 | 356 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3664 | 3616 | 48 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 887 | 296 | 591 |  |
...
| `services::discord::runtime_store` | `src/services/discord/runtime_store.rs` | 372 | 344 | 28 |  |
| `services::discord::semantic_boundaries` | `src/services/discord/semantic_boundaries.rs` | 290 | 290 | 0 |  |
| `services::discord::session_identity` | `src/services/discord/session_identity.rs` | 214 | 141 | 73 |  |
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4131 | 1631 | 2500 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 1894 | 1463 | 431 | giant-file |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 4007 | 4007 | 0 | giant-file |
...
| `services::discord::tui_prompt_relay::codex_idle_rollout` | `src/services/discord/tui_prompt_relay/codex_idle_rollout.rs` | 576 | 576 | 0 |  |
...
| `services::discord::tui_prompt_relay::rehydration` | `src/services/discord/tui_prompt_relay/rehydration.rs` | 990 | 793 | 197 |  |
...
| `services::discord::turn_bridge::streaming_edit_text` | `src/services/discord/turn_bridge/streaming_edit_text.rs` | 346 | 135 | 211 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1730 | 653 | 1077 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 4540 | 2781 | 1759 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 1734 | 1550 | 184 | giant-file |
...
| `services::observability::emit` | `src/services/observability/emit.rs` | 1001 | 674 | 327 |  |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 3737 | 1709 | 2028 | giant-file |
