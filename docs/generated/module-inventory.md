...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1440 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5916 | giant-file |
| `services::discord::health::mailbox` | `src/services/discord/health/mailbox.rs` | 1315 | giant-file |
