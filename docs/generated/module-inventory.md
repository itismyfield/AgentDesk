...
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 12 |  |
| `db::auto_queue::core` | `src/db/auto_queue/core.rs` | 5114 | giant-file |
| `db::auto_queue::phase_gates` | `src/db/auto_queue/phase_gates.rs` | 358 |  |
| `db::auto_queue::queries` | `src/db/auto_queue/queries.rs` | 484 |  |
| `db::auto_queue::slots` | `src/db/auto_queue/slots.rs` | 772 |  |
...
| `kanban` | `src/kanban/mod.rs` | 16 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 2390 | giant-file |
...
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 428 |  |
...
| `services::api_friction` | `src/services/api_friction/mod.rs` | 25 |  |
| `services::api_friction::core` | `src/services/api_friction/core.rs` | 498 |  |
