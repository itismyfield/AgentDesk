...
| `db::auto_queue` | `src/db/auto_queue.rs` | 3740 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 2992 | giant-file |
...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder.rs` | 1411 | giant-file |
