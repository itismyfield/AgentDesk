...
| `services` | `src/services/mod.rs` | 144 | 144 | 0 |  |
...
| `services::claude` | `src/services/claude.rs` | 4281 | 2947 | 1334 | giant-file |
| `services::claude::backend_routing` | `src/services/claude/backend_routing.rs` | 122 | 122 | 0 |  |
| `services::claude_compact_context` | `src/services/claude_compact_context.rs` | 968 | 691 | 277 |  |
| `services::claude_compact_trigger` | `src/services/claude_compact_trigger.rs` | 173 | 136 | 37 |  |
...
| `services::claude_tui::session` | `src/services/claude_tui/session.rs` | 835 | 434 | 401 |  |
...
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 906 | 839 | 67 |  |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 864 | 864 | 0 |  |
...
| `services::discord::tui_prompt_relay::observed_prompt_decision` | `src/services/discord/tui_prompt_relay/observed_prompt_decision.rs` | 115 | 74 | 41 |  |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 4586 | 2086 | 2500 | giant-file |
