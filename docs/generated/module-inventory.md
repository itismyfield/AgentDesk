...
| `engine::ops` | `src/engine/ops.rs` | 162 |  |
| `engine::ops::agent_ops` | `src/engine/ops/agent_ops.rs` | 166 |  |
| `engine::ops::auto_queue_ops` | `src/engine/ops/auto_queue_ops.rs` | 610 |  |
...
| `engine::ops::kanban_ops` | `src/engine/ops/kanban_ops.rs` | 780 |  |
...
| `engine::ops::review_automation_ops` | `src/engine/ops/review_automation_ops.rs` | 456 |  |
| `engine::ops::review_ops` | `src/engine/ops/review_ops.rs` | 338 |  |
| `engine::ops::runtime_ops` | `src/engine/ops/runtime_ops.rs` | 103 |  |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1368 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 6615 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 3378 | giant-file |
...
| `services::auto_queue` | `src/services/auto_queue.rs` | 922 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 2181 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2043 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 3141 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2037 | giant-file |
...
| `services::settings` | `src/services/settings.rs` | 313 |  |
