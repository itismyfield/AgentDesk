...
| `config` | `src/config.rs` | 2241 | giant-file |
...
| `dispatch` | `src/dispatch/mod.rs` | 4924 | giant-file |
...
| `kanban` | `src/kanban.rs` | 3904 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 158 |  |
...
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 1012 | giant-file |
...
| `services::auto_queue::order_routes` | `src/services/auto_queue/order_routes.rs` | 583 |  |
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 303 |  |
| `services::auto_queue::planning` | `src/services/auto_queue/planning.rs` | 499 |  |
...
| `services::auto_queue::route_generate` | `src/services/auto_queue/route_generate.rs` | 695 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5744 | giant-file |
...
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1266 | giant-file |
| `services::discord::discord_io` | `src/services/discord/discord_io.rs` | 558 |  |
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3132 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 826 |  |
| `services::discord::handoff` | `src/services/discord/handoff.rs` | 260 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 5384 | giant-file |
| `services::discord::idle_detector` | `src/services/discord/idle_detector.rs` | 587 |  |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1241 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4789 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2047 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 2658 | giant-file |
...
| `services::discord::stall_recovery` | `src/services/discord/stall_recovery.rs` | 89 |  |
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 10063 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 3922 | giant-file |
...
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 938 |  |
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2151 | giant-file |
