...
| `integration_tests::discord_flow::scenarios` | `src/integration_tests/discord_flow/scenarios.rs` | 630 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 3173 | giant-file |
