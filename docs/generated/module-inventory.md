...
| `db::agents` | `src/db/agents.rs` | 615 |  |
| `db::auto_queue` | `src/db/auto_queue.rs` | 5338 | giant-file |
...
| `engine::transition_executor_pg` | `src/engine/transition_executor_pg.rs` | 678 |  |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 9838 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2198 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 1993 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 4608 | giant-file |
