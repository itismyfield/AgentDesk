...
| `db::auto_queue::consultation` | `src/db/auto_queue/consultation.rs` | 120 |  |
| `db::auto_queue::entries` | `src/db/auto_queue/entries.rs` | 1436 | giant-file |
...
| `server::routes::dispatches::thread_reuse` | `src/server/routes/dispatches/thread_reuse.rs` | 1383 | giant-file |
...
| `services::api_friction` | `src/services/api_friction/mod.rs` | 32 |  |
| `services::api_friction::core` | `src/services/api_friction/core.rs` | 52 |  |
| `services::api_friction::issues` | `src/services/api_friction/issues.rs` | 372 |  |
...
| `services::dispatches::discord_delivery::orchestration` | `src/services/dispatches/discord_delivery/orchestration.rs` | 1692 | giant-file |
