...
| `db::auto_queue` | `src/db/auto_queue.rs` | 5867 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5180 | giant-file |
...
| `services::analytics` | `src/services/analytics.rs` | 1049 | giant-file |
