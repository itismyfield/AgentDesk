...
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 6497 | giant-file |
...
| `services::api_friction` | `src/services/api_friction/mod.rs` | 18 |  |
| `services::api_friction::core` | `src/services/api_friction/core.rs` | 1090 | giant-file |
...
| `services::api_friction::tests::parser` | `src/services/api_friction/tests/parser.rs` | 30 |  |
