...
| `cli::init` | `src/cli/init.rs` | 1587 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 2979 | giant-file |
...
| `engine::ops` | `src/engine/ops.rs` | 188 |  |
...
| `engine::ops::review_automation_ops` | `src/engine/ops/review_automation_ops.rs` | 2719 | giant-file |
...
| `github::sync` | `src/github/sync.rs` | 1232 | giant-file |
...
| `reconcile` | `src/reconcile.rs` | 600 |  |
...
| `server` | `src/server/mod.rs` | 3001 | giant-file |
...
| `server::routes` | `src/server/routes/mod.rs` | 237 |  |
...
| `server::routes::analytics` | `src/server/routes/analytics.rs` | 1304 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 2660 | giant-file |
...
| `server::routes::domains::admin` | `src/server/routes/domains/admin.rs` | 81 |  |
| `server::routes::domains::agents` | `src/server/routes/domains/agents.rs` | 43 |  |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 209 |  |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 482 |  |
| `server::routes::hooks` | `src/server/routes/hooks.rs` | 202 |  |
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 4739 | giant-file |
...
| `server::routes::review_verdict::verdict_route` | `src/server/routes/review_verdict/verdict_route.rs` | 587 |  |
...
| `services::auto_queue` | `src/services/auto_queue.rs` | 1333 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 2454 | giant-file |
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 722 |  |
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1106 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2861 | giant-file |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 809 |  |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2387 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 7034 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2397 | giant-file |
...
| `services::observability` | `src/services/observability.rs` | 1783 | giant-file |
