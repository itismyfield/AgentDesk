...
| `kanban` | `src/kanban.rs` | 4022 | giant-file |
...
| `services::api_friction` | `src/services/api_friction.rs` | 1093 | giant-file |
| `services::api_friction::tests` | `src/services/api_friction/tests/mod.rs` | 5 |  |
| `services::api_friction::tests::helpers` | `src/services/api_friction/tests/helpers.rs` | 150 |  |
| `services::api_friction::tests::memory_sync` | `src/services/api_friction/tests/memory_sync.rs` | 163 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4971 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 5952 | giant-file |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 476 |  |
