...
| `config` | `src/config.rs` | 3110 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 1877 | giant-file |
...
| `dispatch::dispatch_context` | `src/dispatch/dispatch_context.rs` | 5978 | giant-file |
...
| `engine::loader` | `src/engine/loader.rs` | 962 |  |
...
| `engine::ops::http_ops` | `src/engine/ops/http_ops.rs` | 178 |  |
...
| `server::maintenance` | `src/server/maintenance.rs` | 1049 | giant-file |
...
| `server::routes::auto_queue` | `src/server/routes/auto_queue.rs` | 182 |  |
| `server::routes::automation_candidates` | `src/server/routes/automation_candidates.rs` | 330 |  |
| `server::routes::cluster` | `src/server/routes/cluster.rs` | 424 |  |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 333 |  |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 1815 | giant-file |
| `server::routes::home_metrics` | `src/server/routes/home_metrics.rs` | 607 |  |
| `server::routes::hooks` | `src/server/routes/hooks.rs` | 129 |  |
| `server::routes::idle_recap` | `src/server/routes/idle_recap.rs` | 163 |  |
...
| `server::routes::review_verdict::decision_route` | `src/server/routes/review_verdict/decision_route.rs` | 3554 | giant-file |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1085 | giant-file |
| `server::ws` | `src/server/ws.rs` | 277 |  |
| `services` | `src/services/mod.rs` | 75 |  |
...
| `services::auto_queue::route` | `src/services/auto_queue/route.rs` | 98 |  |
...
| `services::claude` | `src/services/claude.rs` | 3762 | giant-file |
| `services::claude_tui` | `src/services/claude_tui/mod.rs` | 6 |  |
| `services::claude_tui::hook_bundle` | `src/services/claude_tui/hook_bundle.rs` | 982 |  |
| `services::claude_tui::hook_relay` | `src/services/claude_tui/hook_relay.rs` | 420 |  |
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 437 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 442 |  |
| `services::claude_tui::session` | `src/services/claude_tui/session.rs` | 270 |  |
| `services::claude_tui::transcript_tail` | `src/services/claude_tui/transcript_tail.rs` | 295 |  |
| `services::cluster` | `src/services/cluster/mod.rs` | 19 |  |
...
| `services::cluster::registry_adapter_sink` | `src/services/cluster/registry_adapter_sink.rs` | 260 |  |
| `services::cluster::session_discovery` | `src/services/cluster/session_discovery.rs` | 577 |  |
| `services::cluster::session_matcher` | `src/services/cluster/session_matcher.rs` | 840 |  |
| `services::cluster::session_registry` | `src/services/cluster/session_registry.rs` | 572 |  |
| `services::cluster::stream_relay` | `src/services/cluster/stream_relay.rs` | 506 |  |
| `services::cluster::watcher_supervisor` | `src/services/cluster/watcher_supervisor.rs` | 514 |  |
| `services::codex` | `src/services/codex.rs` | 3232 | giant-file |
| `services::codex_remote_policy` | `src/services/codex_remote_policy.rs` | 49 |  |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 717 |  |
| `services::codex_tui` | `src/services/codex_tui/mod.rs` | 3 |  |
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 957 |  |
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 1375 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 326 |  |
| `services::discord` | `src/services/discord/mod.rs` | 6427 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1178 | giant-file |
...
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 928 |  |
| `services::discord::commands::diagnostics` | `src/services/discord/commands/diagnostics.rs` | 1064 | giant-file |
...
| `services::discord::discord_io` | `src/services/discord/discord_io.rs` | 585 |  |
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3249 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 876 |  |
| `services::discord::handoff` | `src/services/discord/handoff.rs` | 260 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 5636 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1707 | giant-file |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 603 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5303 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2646 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 8707 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3163 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6167 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3364 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 5459 | giant-file |
...
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 1211 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 3999 | giant-file |
| `services::discord::voice_routing` | `src/services/discord/voice_routing.rs` | 160 |  |
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 1709 | giant-file |
| `services::discord::watchers::lifecycle_decision` | `src/services/discord/watchers/lifecycle_decision.rs` | 255 |  |
| `services::discord_config_audit` | `src/services/discord_config_audit.rs` | 1541 | giant-file |
...
| `services::dispatches::discord_delivery::orchestration` | `src/services/dispatches/discord_delivery/orchestration.rs` | 1718 | giant-file |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1088 | giant-file |
...
| `services::gemini` | `src/services/gemini.rs` | 2571 | giant-file |
...
| `services::observability::emit` | `src/services/observability/emit.rs` | 476 |  |
...
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 428 |  |
| `services::process` | `src/services/process.rs` | 942 |  |
| `services::provider` | `src/services/provider.rs` | 2524 | giant-file |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 761 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2721 | giant-file |
...
| `voice` | `src/voice/mod.rs` | 16 |  |
| `voice::announce_meta` | `src/voice/announce_meta.rs` | 217 |  |
