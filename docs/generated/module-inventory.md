...
| `cli::args` | `src/cli/args.rs` | 1571 | 973 | 598 |  |
...
| `server::routes::agents_crud` | `src/server/routes/agents_crud.rs` | 1333 | 1333 | 0 | giant-file |
...
| `server::routes::escalation` | `src/server/routes/escalation.rs` | 1646 | 1381 | 265 | giant-file |
...
| `server::routes::resume` | `src/server/routes/resume.rs` | 1261 | 1261 | 0 | giant-file |
...
| `server::routes::review_verdict::verdict_route` | `src/server/routes/review_verdict/verdict_route.rs` | 689 | 625 | 64 |  |
...
| `services::claude` | `src/services/claude.rs` | 4314 | 2959 | 1355 | giant-file |
...
| `services::claude_e::process` | `src/services/claude_e/process.rs` | 446 | 388 | 58 |  |
...
| `services::cluster::intake_worker` | `src/services/cluster/intake_worker.rs` | 457 | 342 | 115 |  |
...
| `services::codex` | `src/services/codex.rs` | 3858 | 3138 | 720 | giant-file |
...
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 911 | 844 | 67 |  |
...
| `services::discord::catch_up::classification` | `src/services/discord/catch_up/classification.rs` | 293 | 293 | 0 |  |
...
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 848 | 790 | 58 |  |
...
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 2387 | 990 | 1397 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5853 | 610 | 5243 |  |
...
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 1341 | 988 | 353 |  |
...
| `services::discord::outbound::delivery` | `src/services/discord/outbound/delivery.rs` | 1390 | 740 | 650 |  |
| `services::discord::outbound::delivery_frontier_probe` | `src/services/discord/outbound/delivery_frontier_probe.rs` | 75 | 75 | 0 |  |
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 2963 | 1327 | 1636 | giant-file |
| `services::discord::outbound::manual_delivery` | `src/services/discord/outbound/manual_delivery.rs` | 1205 | 596 | 609 |  |
...
| `services::discord::outbound::send_gate` | `src/services/discord/outbound/send_gate.rs` | 559 | 353 | 206 |  |
...
| `services::discord::placeholder_sweeper::abandon_guard` | `src/services/discord/placeholder_sweeper/abandon_guard.rs` | 752 | 440 | 312 |  |
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder/mod.rs` | 689 | 689 | 0 |  |
| `services::discord::prompt_builder::channel_recent_context` | `src/services/discord/prompt_builder/channel_recent_context.rs` | 420 | 201 | 219 |  |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 2155 | 981 | 1174 |  |
...
| `services::discord::tmux_watcher::liveness` | `src/services/discord/tmux_watcher/liveness.rs` | 698 | 520 | 178 |  |
...
| `services::discord::turn_bridge::retry_state` | `src/services/discord/turn_bridge/retry_state.rs` | 894 | 429 | 465 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 2004 | 740 | 1264 |  |
...
| `services::onboarding` | `src/services/onboarding/mod.rs` | 2990 | 2940 | 50 | giant-file |
...
| `services::platform::binary_resolver` | `src/services/platform/binary_resolver.rs` | 1566 | 1413 | 153 | giant-file |
...
| `services::provider_exec` | `src/services/provider_exec.rs` | 319 | 319 | 0 |  |
...
| `services::qwen` | `src/services/qwen.rs` | 2223 | 2202 | 21 | giant-file |
