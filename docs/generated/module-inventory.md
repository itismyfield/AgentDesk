...
| `server::routes::analytics` | `src/server/routes/analytics.rs` | 1900 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 3668 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 3315 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 11537 | giant-file |
