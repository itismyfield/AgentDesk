...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder/mod.rs` | 604 | 604 | 0 |  |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 204 | 204 | 0 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3061 | 2825 | 236 | giant-file |
...
| `services::discord::router::message_handler::provider_isolation` | `src/services/discord/router/message_handler/provider_isolation.rs` | 757 | 601 | 156 |  |
...
| `services::discord::task_notification_delivery` | `src/services/discord/task_notification_delivery/mod.rs` | 916 | 916 | 0 |  |
...
| `services::discord::task_notification_delivery::store` | `src/services/discord/task_notification_delivery/store.rs` | 986 | 986 | 0 |  |
...
| `services::discord::task_notification_delivery::store::terminal_footer` | `src/services/discord/task_notification_delivery/store/terminal_footer.rs` | 54 | 54 | 0 |  |
| `services::discord::task_notification_delivery::terminal_identity` | `src/services/discord/task_notification_delivery/terminal_identity.rs` | 157 | 157 | 0 |  |
