...
| `db::dispatches::outbox` | `src/db/dispatches/outbox.rs` | 667 |  |
...
| `db::prompt_manifests` | `src/db/prompt_manifests.rs` | 1219 | giant-file |
...
| `server::dto` | `src/server/dto/mod.rs` | 4 |  |
| `server::dto::dispatches` | `src/server/dto/dispatches.rs` | 41 |  |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 2507 | giant-file |
...
| `server::routes::dispatches` | `src/server/routes/dispatches/mod.rs` | 109 |  |
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 444 |  |
| `server::routes::dispatches::discord_delivery` | `src/server/routes/dispatches/discord_delivery.rs` | 2145 | giant-file |
| `server::routes::dispatches::outbox` | `src/server/routes/dispatches/outbox.rs` | 1066 | giant-file |
...
| `server::routes::kanban` | `src/server/routes/kanban.rs` | 3303 | giant-file |
...
| `server::routes::prompt_manifest_retention` | `src/server/routes/prompt_manifest_retention.rs` | 51 |  |
...
| `services` | `src/services/mod.rs` | 66 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5914 | giant-file |
...
| `services::discord::commands::inspect` | `src/services/discord/commands/inspect.rs` | 1062 | giant-file |
...
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1330 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 7105 | giant-file |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events.rs` | 2040 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7013 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6261 | giant-file |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 474 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3111 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4409 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 2338 | giant-file |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 461 |  |
| `services::dispatches::discord_delivery` | `src/services/dispatches/discord_delivery.rs` | 441 |  |
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 587 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 2265 | giant-file |
