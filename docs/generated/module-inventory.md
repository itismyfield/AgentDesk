...
| `server` | `src/server/mod.rs` | 3763 | giant-file |
...
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 809 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5456 | giant-file |
...
| `services::dispatches::discord_delivery::guard` | `src/services/dispatches/discord_delivery/guard.rs` | 627 |  |
