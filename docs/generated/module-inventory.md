...
| `services::claude` | `src/services/claude.rs` | 3619 | giant-file |
...
| `services::claude_tui::hook_relay` | `src/services/claude_tui/hook_relay.rs` | 364 |  |
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 407 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 409 |  |
