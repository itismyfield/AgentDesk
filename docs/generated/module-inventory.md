...
| `config` | `src/config.rs` | 3121 | 2722 | 399 | giant-file |
...
| `server::outbox_actionable_delivery` | `src/server/outbox_actionable_delivery.rs` | 116 | 84 | 32 |  |
...
| `server::routes::message_outbox` | `src/server/routes/message_outbox.rs` | 471 | 278 | 193 |  |
...
| `services` | `src/services/mod.rs` | 142 | 142 | 0 |  |
...
| `services::cluster::intake_router_hook` | `src/services/cluster/intake_router_hook.rs` | 2154 | 824 | 1330 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5554 | 4170 | 1384 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1095 | 994 | 101 |  |
| `services::discord::answer_flush_barrier` | `src/services/discord/answer_flush_barrier.rs` | 511 | 209 | 302 |  |
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 3394 | 1769 | 1625 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 879 | 726 | 153 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 5594 | 2561 | 3033 | giant-file |
...
| `services::discord::idle_detector` | `src/services/discord/idle_detector.rs` | 1000 | 537 | 463 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5813 | 608 | 5205 |  |
...
| `services::discord::org_schema` | `src/services/discord/org_schema.rs` | 427 | 427 | 0 |  |
...
| `services::discord::outbound::manual_delivery` | `src/services/discord/outbound/manual_delivery.rs` | 1178 | 582 | 596 |  |
...
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder/mod.rs` | 600 | 600 | 0 |  |
...
| `services::discord::recovery_engine::live_routing` | `src/services/discord/recovery_engine/live_routing.rs` | 209 | 34 | 175 |  |
| `services::discord::recovery_engine::manual_rebind` | `src/services/discord/recovery_engine/manual_rebind/mod.rs` | 1410 | 984 | 426 |  |
...
| `services::discord::recovery_engine::recovery_memory_scope` | `src/services/discord/recovery_engine/recovery_memory_scope.rs` | 294 | 98 | 196 |  |
| `services::discord::recovery_engine::restore_inflight` | `src/services/discord/recovery_engine/restore_inflight.rs` | 2487 | 2314 | 173 | giant-file |
...
| `services::discord::recovery_engine::terminal_text_idempotency` | `src/services/discord/recovery_engine/terminal_text_idempotency.rs` | 889 | 442 | 447 |  |
...
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 649 | 278 | 371 |  |
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 1346 | 868 | 478 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 3311 | 1444 | 1867 | giant-file |
| `services::discord::relay_recovery::tests::circuit_breaker_apply` | `src/services/discord/relay_recovery/tests/circuit_breaker_apply.rs` | 382 | 0 | 382 |  |
| `services::discord::relay_recovery_auto_heal_apply` | `src/services/discord/relay_recovery_auto_heal_apply.rs` | 702 | 294 | 408 |  |
...
| `services::discord::relay_recovery_circuit_breaker` | `src/services/discord/relay_recovery_circuit_breaker.rs` | 1680 | 716 | 964 |  |
...
| `services::discord::role_map` | `src/services/discord/role_map.rs` | 730 | 730 | 0 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1790 | 1694 | 96 | giant-file |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1562 | 1338 | 224 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3105 | 2869 | 236 | giant-file |
...
| `services::discord::router::message_handler::provider_isolation` | `src/services/discord/router/message_handler/provider_isolation.rs` | 717 | 614 | 103 |  |
...
| `services::discord::router::turn_start` | `src/services/discord/router/turn_start.rs` | 673 | 565 | 108 |  |
...
| `services::discord::runtime_bootstrap::recovery_flush` | `src/services/discord/runtime_bootstrap/recovery_flush.rs` | 598 | 598 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4768 | 1676 | 3092 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 964 | 419 | 545 |  |
| `services::discord::session_runtime::channel_routing` | `src/services/discord/session_runtime/channel_routing.rs` | 764 | 731 | 33 |  |
| `services::discord::session_runtime::restore_cwd` | `src/services/discord/session_runtime/restore_cwd.rs` | 353 | 353 | 0 |  |
| `services::discord::session_runtime::thread_bootstrap` | `src/services/discord/session_runtime/thread_bootstrap.rs` | 363 | 189 | 174 |  |
| `services::discord::session_runtime::worktree` | `src/services/discord/session_runtime/worktree.rs` | 601 | 601 | 0 |  |
| `services::discord::settings` | `src/services/discord/settings.rs` | 434 | 434 | 0 |  |
...
| `services::discord::settings::validation` | `src/services/discord/settings/validation.rs` | 1185 | 455 | 730 |  |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 1306 | 764 | 542 |  |
...
| `services::discord::tmux_watcher::task_response_authority` | `src/services/discord/tmux_watcher/task_response_authority.rs` | 472 | 472 | 0 |  |
...
| `services::discord::tui_prompt_relay::task_notification_prompt` | `src/services/discord/tui_prompt_relay/task_notification_prompt.rs` | 228 | 228 | 0 |  |
...
| `services::discord::turn_bridge::completion_postlude` | `src/services/discord/turn_bridge/completion_postlude.rs` | 936 | 936 | 0 |  |
...
| `services::discord::turn_bridge::memory_lifecycle` | `src/services/discord/turn_bridge/memory_lifecycle.rs` | 511 | 328 | 183 |  |
...
| `services::discord::turn_bridge::response_delivery` | `src/services/discord/turn_bridge/response_delivery.rs` | 191 | 76 | 115 |  |
...
| `services::discord::turn_bridge::terminal_outcome_delivery` | `src/services/discord/turn_bridge/terminal_outcome_delivery.rs` | 880 | 880 | 0 |  |
...
| `services::discord::turn_view_reconciler` | `src/services/discord/turn_view_reconciler.rs` | 2213 | 2213 | 0 | giant-file |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2895 | 2069 | 826 | giant-file |
...
| `services::discord_config_audit` | `src/services/discord_config_audit.rs` | 1601 | 1288 | 313 | giant-file |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1281 | 1173 | 108 | giant-file |
...
| `services::issue_announcements` | `src/services/issue_announcements.rs` | 479 | 435 | 44 |  |
...
| `services::memory::memento` | `src/services/memory/memento.rs` | 2126 | 1897 | 229 | giant-file |
...
| `services::queue` | `src/services/queue.rs` | 956 | 875 | 81 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 7199 | 3290 | 3909 | giant-file |
