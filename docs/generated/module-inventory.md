...
| `server` | `src/server/mod.rs` | 3374 | giant-file |
...
| `services` | `src/services/mod.rs` | 59 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events.rs` | 1529 | giant-file |
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 554 |  |
| `services::discord::prompt_builder` | `src/services/discord/prompt_builder.rs` | 2328 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 1839 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4313 | giant-file |
...
| `services::observability` | `src/services/observability/mod.rs` | 3395 | giant-file |
...
| `services::observability::turn_lifecycle` | `src/services/observability/turn_lifecycle.rs` | 445 |  |
...
| `services::pipeline_routes` | `src/services/pipeline_routes.rs` | 643 |  |
