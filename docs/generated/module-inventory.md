...
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 4419 | giant-file |
...
| `config` | `src/config.rs` | 2716 | giant-file |
| `crate` | `src/main.rs` | 48 |  |
| `credential` | `src/credential.rs` | 106 |  |
| `db` | `src/db/mod.rs` | 341 |  |
| `db::agents` | `src/db/agents.rs` | 1128 | giant-file |
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 18 |  |
| `db::auto_queue::claim` | `src/db/auto_queue/claim.rs` | 688 |  |
| `db::auto_queue::consultation` | `src/db/auto_queue/consultation.rs` | 243 |  |
| `db::auto_queue::core` | `src/db/auto_queue/core.rs` | 4529 | giant-file |
| `db::auto_queue::phase_gates` | `src/db/auto_queue/phase_gates.rs` | 358 |  |
| `db::auto_queue::queries` | `src/db/auto_queue/queries.rs` | 484 |  |
...
| `db::dispatches::outbox` | `src/db/dispatches/outbox/mod.rs` | 39 |  |
| `db::dispatches::outbox::claim` | `src/db/dispatches/outbox/claim.rs` | 74 |  |
| `db::dispatches::outbox::delivery` | `src/db/dispatches/outbox/delivery.rs` | 164 |  |
| `db::dispatches::outbox::diagnostics` | `src/db/dispatches/outbox/diagnostics.rs` | 44 |  |
| `db::dispatches::outbox::followup` | `src/db/dispatches/outbox/followup.rs` | 91 |  |
| `db::dispatches::outbox::model` | `src/db/dispatches/outbox/model.rs` | 54 |  |
...
| `db::kanban_cards` | `src/db/kanban_cards/mod.rs` | 348 |  |
| `db::kanban_cards::crud` | `src/db/kanban_cards/crud.rs` | 442 |  |
| `db::kanban_cards::listing` | `src/db/kanban_cards/listing.rs` | 311 |  |
...
| `kanban` | `src/kanban/mod.rs` | 23 |  |
| `kanban::audit` | `src/kanban/audit.rs` | 59 |  |
| `kanban::github_sync` | `src/kanban/github_sync.rs` | 242 |  |
| `kanban::hooks` | `src/kanban/hooks.rs` | 496 |  |
| `kanban::state_machine` | `src/kanban/state_machine.rs` | 1622 | giant-file |
| `kanban::terminal_cleanup` | `src/kanban/terminal_cleanup.rs` | 339 |  |
| `kanban::test_support` | `src/kanban/test_support.rs` | 484 |  |
| `kanban::transition_cleanup` | `src/kanban/transition_cleanup.rs` | 416 |  |
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 427 |  |
...
| `server::dto::agents` | `src/server/dto/agents.rs` | 493 |  |
...
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 704 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5406 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 298 |  |
...
| `services` | `src/services/mod.rs` | 68 |  |
| `services::agent_protocol` | `src/services/agent_protocol.rs` | 272 |  |
...
| `services::api_friction` | `src/services/api_friction/mod.rs` | 28 |  |
| `services::api_friction::core` | `src/services/api_friction/core.rs` | 364 |  |
...
| `services::api_friction::tests::helpers` | `src/services/api_friction/tests/helpers.rs` | 199 |  |
...
| `services::api_friction::tests::processing` | `src/services/api_friction/tests/processing.rs` | 79 |  |
| `services::auto_queue` | `src/services/auto_queue.rs` | 1495 | giant-file |
| `services::auto_queue::activate_bridge` | `src/services/auto_queue/activate_bridge.rs` | 24 |  |
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 1073 | giant-file |
...
| `services::auto_queue::fsm` | `src/services/auto_queue/fsm.rs` | 861 |  |
| `services::auto_queue::order_routes` | `src/services/auto_queue/order_routes.rs` | 576 |  |
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 361 |  |
...
| `services::auto_queue::view` | `src/services/auto_queue/view.rs` | 327 |  |
| `services::auto_queue::view_admin_routes` | `src/services/auto_queue/view_admin_routes.rs` | 713 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 6073 | giant-file |
...
| `services::discord::commands` | `src/services/discord/commands/mod.rs` | 101 |  |
...
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1341 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1323 | giant-file |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 554 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5026 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7450 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 2873 | giant-file |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 491 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3207 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4539 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 2342 | giant-file |
...
| `services::discord::turn_bridge::output_lifecycle` | `src/services/discord/turn_bridge/output_lifecycle.rs` | 75 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 1686 | giant-file |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 466 |  |
| `services::dispatches::discord_delivery` | `src/services/dispatches/discord_delivery/mod.rs` | 28 |  |
| `services::dispatches::discord_delivery::guard` | `src/services/dispatches/discord_delivery/guard.rs` | 619 |  |
| `services::dispatches::discord_delivery::orchestration` | `src/services/dispatches/discord_delivery/orchestration.rs` | 1670 | giant-file |
| `services::dispatches::discord_delivery::transport` | `src/services/dispatches/discord_delivery/transport.rs` | 786 |  |
| `services::dispatches::outbox_claiming` | `src/services/dispatches/outbox_claiming.rs` | 267 |  |
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 584 |  |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 411 |  |
