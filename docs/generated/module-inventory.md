...
| `config` | `src/config.rs` | 2862 | giant-file |
| `crate` | `src/main.rs` | 48 |  |
| `credential` | `src/credential.rs` | 106 |  |
| `db` | `src/db/mod.rs` | 342 |  |
...
| `db::dispatches::outbox` | `src/db/dispatches/outbox/mod.rs` | 42 |  |
| `db::dispatches::outbox::claim` | `src/db/dispatches/outbox/claim.rs` | 148 |  |
| `db::dispatches::outbox::delivery` | `src/db/dispatches/outbox/delivery.rs` | 164 |  |
| `db::dispatches::outbox::diagnostics` | `src/db/dispatches/outbox/diagnostics.rs` | 78 |  |
...
| `dispatch::dispatch_cancel` | `src/dispatch/dispatch_cancel.rs` | 581 |  |
...
| `dispatch::dispatch_create` | `src/dispatch/dispatch_create.rs` | 3733 | giant-file |
...
| `server::cluster` | `src/server/cluster.rs` | 1022 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5461 | giant-file |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 467 |  |
...
| `services::dispatches::outbox_claiming` | `src/services/dispatches/outbox_claiming.rs` | 826 |  |
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 614 |  |
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1075 | giant-file |
| `services::dispatches::routing_constraint` | `src/services/dispatches/routing_constraint.rs` | 573 |  |
