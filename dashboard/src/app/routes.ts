...
export const VIEW_REGISTRY: RouteEntry[] = [
  ...
  { id: "chat", icon: "💬", labelKo: "채팅", labelEn: "Chat", nav: false, palette: true, loadingKo: "채팅 로딩 중...", loadingEn: "Loading Chat..." },
  { id: "skills", icon: "🧩", labelKo: "스킬", labelEn: "Skills", nav: false, palette: true, loadingKo: "스킬 로딩 중...", loadingEn: "Loading Skills..." },
