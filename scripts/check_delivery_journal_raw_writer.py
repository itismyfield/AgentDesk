...
#     kills no test; a dropped settle only self-reports later, as an `Unknown`
#     classification in shadow data.
...
# Rust runtime tests T1-T9 and their mutations M1-M7 (see the SOURCE-CONTRACT
