...
require_fixed_string "fn active_dispatch_slot_guard_sql" src/db/auto_queue/claim.rs
require_fixed_string "pub async fn slot_has_active_dispatch_pg" src/db/auto_queue/slots.rs
