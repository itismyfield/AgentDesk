...
pub(super) fn fresh_provider_session_probe_allowed(run: &RunningAgentRoutineRun, now: DateTime<Utc>) -> bool {
...
impl RoutineAgentExecutor {
        ...
        pub(super) async fn fresh_provider_session_failure(&self, run: &RunningAgentRoutineRun) -> Option<String> {
