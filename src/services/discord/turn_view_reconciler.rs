...
// #4278: orphan-`⏳` defense sweep (enumeration + persisted-identity removal +
// pure verdict). A descendant module so it can reach the reconciler's private
// target store / persistence helpers while keeping this file's core lifecycle
// unchanged.
mod orphan_sweep;
pub(in crate::services::discord) use orphan_sweep::sweep_orphan_tui_anchors_with_probes;
