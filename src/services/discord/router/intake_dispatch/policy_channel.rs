...
const POLICY_LOOKUP_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(5);
...
pub(super) async fn resolve(
    ...
    let metadata = tokio::time::timeout(POLICY_LOOKUP_TIMEOUT, channel.to_channel(deps.http))
        .await
