...
use routine_metadata::{
    fresh_routine_turn, routine_metadata_agent_id, routine_metadata_role_binding,
...
pub(super) async fn start_reserved_headless_turn_with_owner(
    ...
    let context_prompt = TurnContext {
        ...
        trigger: build_headless_trigger_context(source, metadata.as_ref()),
        ...
        user_input: ai_screen::sanitize_user_input(&effective_prompt),
    }
    .build();
