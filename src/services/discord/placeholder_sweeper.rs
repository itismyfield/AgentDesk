    ...
    tokio::spawn(async move {
        ...
        loop {
                ...
                || swept_orphan_anchors > 0
            {
                ...
                tracing::info!(
                    "  [{ts}] 🧹 placeholder sweeper ({}): scanned={} stalled={} abandoned={} reclaimed_panels={} drained_orphans={} recovered_panel_transitions={} drained_abort_markers={} drained_abandon_requests={} swept_busy_retry_bindings={} swept_orphan_anchors={}",
                    provider.as_str(),
                    report.scanned,
                    report.stalled,
                    report.abandoned,
