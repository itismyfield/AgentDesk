...
/// #3394: drop whole trailing sections until the panel fits when possible. Every
/// return path passes through `repair_fence_parity`; a lone overflowing section
/// is unit-truncated first, then fence-rebalanced, with a visible `...` marker
/// appended after the rebalance.
