...
/// The explicit-background force-clean decision off one snapshot; records the refusal
/// when only the UNMEASURED tail refused (a drained tail would have admitted).
