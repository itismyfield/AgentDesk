...
pub(super) enum SoftTerminalAuthorityDenial {
...
impl SoftTerminalAuthorityDenial {
    ...
    pub(super) fn route_label(self) -> &'static str {
        match self {
    ...
    pub(super) fn metric_name(self) -> &'static str {
        match self {
...
pub(super) struct WatcherSoftTerminalAuthority {
...
impl WatcherSoftTerminalAuthority {
    ...
    pub(super) fn startup_snapshot_authorized(&self) -> bool {
    ...
    pub(super) fn authorize_pre_relay_inflight(
        &self,
