...
mod worker;
use self::worker::*;
pub(in crate::services::discord) use self::worker::{
    demote_stale_foreign_inflight_if_current, record_claim_marker_if_watcher_owned,
    record_inline_claim_marker_if_claimed,
};
pub(super) use self::worker::{pin_abort_foreign_identity, spawn_worker};
