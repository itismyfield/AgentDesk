                    ...
                    match msg {
                        ...
                        StreamMessage::Thinking { summary } => {
                            ...
                            let prev_for_preserve = current_tool_line
                                .as_deref()
                                .map(super::super::formatting::finalize_in_progress_tool_status);
                            super::super::formatting::preserve_previous_tool_status(
                                &mut prev_tool_status,
                        ...
                        StreamMessage::ToolUse {
                            ...
                            record_placeholder_live_event(
                                shared_owned.as_ref(),
                                channel_id,
                                super::super::placeholder_live_events::RecentPlaceholderEvent::tool_use(
                                    &name, &input,
                                ),
                            );
                            status_panel_dirty |= record_status_panel_events(
                                shared_owned.as_ref(),
                                channel_id,
                                super::super::placeholder_live_events::status_events_from_tool_use_with_id(
                                    &name,
                                    &input,
                            ...
                            let long_running_tool = if !is_dcserver_restart_command(&input) {
                                super::super::formatting::classify_long_running_tool(&name, &input)
                            } else {
                                None
                            };
                            if matches!(
                                ...
                                Some((
                                    _,
                                    super::super::formatting::LongRunningCloseTrigger::BackgroundDispatch,
                                    _
                                ))
                            ) {
                        ...
                        StreamMessage::ToolResult {
                            ...
                            if is_error {
                                record_placeholder_live_event(
                                    &shared_owned,
                                    channel_id,
                                    super::super::placeholder_live_events::RecentPlaceholderEvent::tool_error(
                                        &content,
                                    ),
                                );
                            }
                            status_panel_dirty |= record_status_panel_events(
                                shared_owned.as_ref(),
                                channel_id,
                                super::super::placeholder_live_events::status_events_from_tool_result_with_id(
                                ...
                                long_running_placeholder_active.take()
                            {
                                let monitor_like = matches!(
                                    close_trigger,
                                    super::super::formatting::LongRunningCloseTrigger::MonitorLike
                                );
                        ...
                        StreamMessage::TaskNotification {
                            ...
                            record_placeholder_live_event(
                                shared_owned.as_ref(),
                                channel_id,
                                super::super::placeholder_live_events::RecentPlaceholderEvent::task_notification(
                                    kind.as_str(),
                                    &status,
                                    &summary,
                                ),
                            ...
                            status_panel_dirty |= record_status_panel_events(
                                shared_owned.as_ref(),
                                channel_id,
                                super::super::placeholder_live_events::status_events_from_task_notification_with_tool_use_id(
                                    kind.as_str(),
                                    &status,
                                    &summary,
                                    tool_use_id.as_deref(),
                            ...
                            if single_message_panel_footer_mode {
                                let indicator =
                                    super::super::single_message_panel::single_message_panel_spinner_frame(
                                        spin_idx,
                                    );
