...
mod tests {
    ...
    /// A failed delete leaves the candidate queued for orphan cleanup; a
    /// successful one leaves nothing behind.
    #[tokio::test]
    async fn cleanup_deletes_the_candidate_and_queues_it_only_when_delete_fails() {
