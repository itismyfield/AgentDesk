...
mod tests {
    ...
    fn post_loop_finalize_saves_require_matching_identity() {
        ...
        let mut original =
            state_with_full_response(44_259, "partial response", "AgentDesk-codex-post-loop-4259");
        original.long_running_placeholder_active = true;
        ...
        let persisted = super::super::load_inflight_state(
            &ProviderKind::Codex,
            original.channel_id,
        )
