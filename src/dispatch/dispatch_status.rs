...
/// Transaction-scoped canonical dispatch-status pipeline for callers that must
/// compose the terminal transition with another durable write. The caller owns
/// commit and the post-commit constraint-release wake.
