...
use super::transition_core::PgTransitionCleanupCounts;
...
pub(super) async fn skip_live_auto_queue_entries_for_card_on_pg_tx(
    tx: &mut sqlx::Transaction<'_, sqlx::Postgres>,
    card_id: &str,
) -> anyhow::Result<usize> {
    let rows = sqlx::query(
...
pub(super) async fn clear_force_transition_terminalized_links_on_pg_tx(
    tx: &mut sqlx::Transaction<'_, sqlx::Postgres>,
    card_id: &str,
) -> anyhow::Result<()> {
    sqlx::query(
...
pub(super) async fn cancel_active_dispatches_for_card_on_pg_tx(
    tx: &mut sqlx::Transaction<'_, sqlx::Postgres>,
    card_id: &str,
    reason: Option<&str>,
...
pub(super) async fn cleanup_force_transition_revert_fields_on_pg_tx(
    tx: &mut sqlx::Transaction<'_, sqlx::Postgres>,
    card_id: &str,
) -> anyhow::Result<()> {
