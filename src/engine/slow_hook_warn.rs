...
mod tests {
    ...
    fn emits_first_slow_hook_warning_then_only_every_nth_occurrence() {
        ...
        let emitted = (1..=calls)
            .filter(|_| should_emit("rate-limit-proof-policy-4250", "onTick5min"))
            .count();
