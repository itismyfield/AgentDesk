...
EXPECTED_TEST_NON_PG_COMMANDS = (
    ...
    "cargo test --lib provider_error_transcript::tests -- --skip _pg --skip pg_ --skip postgres",
    "cargo test --lib placeholder_live_events::tests -- --skip _pg --skip pg_ --skip postgres",
    ...
    "cargo test --lib tmux::tmux_watcher::loop_poll_prologue::tests -- --skip _pg --skip pg_ --skip postgres",
    "cargo test --lib tmux::tmux_watcher::terminal_abort_exits::tests -- --skip _pg --skip pg_ --skip postgres",
