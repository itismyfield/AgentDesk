...
test-non-pg:
    ...
    # Active Claude usage must reach compact triggering before watcher completion.
    cargo test --lib claude_compact_trigger::tests
    cargo test --lib assistant_usage_emits_complete_live_snapshot_before_done
    cargo test --lib complete_status_snapshot_reaches_active_usage_observer
    cargo test --lib idle_status_observation_runs_before_prose_without_creating_content
